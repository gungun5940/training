...
if ( !empty($this->item['permit']['del']) ) {
	...
	$arr['form'] = '<form class="js-submit-form" action="'.URL.'members/del"></form>';
	$arr['hiddenInput'][] = array('name'=>'id','value'=>$this->item['id']);
	$arr['body'] = "คุณต้องการลบ <span class=\"fwb\">\"{$this->item['fullname']}\" @{$this->item['username']}</span> ใช่หรือไม่?";
	...
	$arr['body'] = "คุณไม่สามารถลบ <span class=\"fwb\">\"{$this->item['fullname']}\" @{$this->item['username']}</span> ได้ !";
