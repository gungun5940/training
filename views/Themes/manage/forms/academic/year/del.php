...
if ( !empty($this->item['permit']['del']) ) {
	...
	$arr['form'] = '<form class="js-submit-form" action="'.URL. 'year/del/"></form>';
	$arr['hiddenInput'][] = array('name'=>'id','value'=>$this->item['id']);
	$arr['body'] = "คุณต้องการลบ <span class=\"fwb\">\"ปีการศึกษา {$this->item['name']}\"</span> หรือไม่?";
	...
	$arr['body'] = "คุณไม่สามารถลบ <span class=\"fwb\">\"ปีการศึกษา {$this->item['name']}\"</span> ได้?";	
