...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 16, 2021 at 01:37 PM
...
CREATE TABLE `course` (
  ...
  `course_open_status` int(1) NOT NULL,
  `course_staff_id` int(11) NOT NULL,
  `course_created` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `course_updated` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `course` (`course_id`, `course_code`, `course_name_th`, `course_name_en`, `course_object`, `course_goal`, `course_property`, `course_hours`, `course_link`, `course_status`, `course_open_status`, `course_staff_id`, `course_created`, `course_updated`) VALUES
(5, '123401', 'วิศวกรรมซอฟต์แวร์', 'Software Engineering', '-', '-', '-', 40, '', '1', 1, 7, '2020-10-19 02:22:06', '2020-10-19 02:23:25'),
(6, '123402', 'ทดสอบ', 'test', '-', '-', '-', 40, '', '1', 1, 7, '2020-10-19 03:01:40', '2020-11-16 13:37:41'),
(7, '123403', 'ทดสอบ1', 'test1', '-', '-', '-', 30, '', '1', 1, 7, '2020-10-19 03:38:52', '2020-10-19 05:10:15');
...
CREATE TABLE `course_open` (
  ...
  `open_price` float(11,2) NOT NULL,
  `open_member` int(3) NOT NULL,
  `open_startdate_reg` date NOT NULL,
  `open_enddate_reg` date NOT NULL,
  `open_place` varchar(50) NOT NULL,
  `open_staff_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `course_open` (`open_id`, `open_course`, `open_startyear`, `open_endyear`, `open_date`, `open_startdate`, `open_enddate`, `open_status`, `open_price`, `open_member`, `open_startdate_reg`, `open_enddate_reg`, `open_place`, `open_staff_id`) VALUES
(7, '5', '2563', '2573', '2020-10-05', '2020-10-05', '2030-10-04', '1', 0.00, 50, '2020-10-05', '2020-10-16', '', 0),
(8, '6', '2563', '2563', '2020-10-01', '2020-10-01', '2020-10-31', '0', 0.00, 30, '2020-10-01', '2020-10-20', '', 0),
(9, '6', '2563', '2564', '2020-10-01', '2020-10-01', '2020-10-31', '0', 500.00, 40, '2020-10-01', '2020-10-20', '', 0),
(10, '6', '2563', '2564', '2020-10-01', '2020-10-01', '2020-10-31', '0', 500.00, 50, '2020-10-01', '2020-10-20', '', 0),
(11, '7', '2563', '2564', '2020-10-01', '2020-10-01', '2020-10-31', '0', 500.00, 50, '2020-10-01', '2020-10-20', '', 0),
(12, '7', '2563', '2564', '2020-10-19', '2020-10-19', '2020-10-19', '1', 600.00, 40, '2020-10-19', '2020-10-19', '', 0),
(13, '6', '', '', '2020-11-17', '2020-11-22', '2020-11-25', '1', 0.00, 30, '2020-11-17', '2020-11-20', 'ทดสอบ', 8),
(14, '5', '', '', '2020-11-16', '2020-11-20', '2020-11-23', '1', 500.00, 30, '2020-11-17', '2020-11-19', 'ทดสอบ', 8),
(15, '5', '', '', '2021-01-07', '2021-01-21', '2021-01-28', '1', 900.00, 40, '2021-01-07', '2021-01-14', 'test', 9);
...
(1, 3, 'กิจกรรมประดิษฐ์โคมประดับเพื่อบูรณาการ การทำนุบำรุงศิลปวัฒนธรรม.jpg', '', 'jpg', 1, 0, '2020-11-17 08:53:52'),
(1, 4, 'เปิดรับสมัครนักศึกษาใหม่ ประจำปีการศึกษา 2564.jpg', '', 'jpg', 2, 0, '2020-11-17 09:03:14'),
(1, 5, 'ประกาศรายชื่อผู้มีสิทธิ์สอบ.jpg', '', 'jpg', 3, 0, '2020-11-17 09:21:51'),
(1, 6, 'การขยายระยะเวลา การรายงานตัวบัณฑิต.jpg', '', 'jpg', 4, 0, '2020-11-17 09:26:33'),
(1, 7, 'กำหนดการส่งแบบความประสงค์ขอกู้ยืมเงินและเอกสารประกอบ.jpg', '', 'jpg', 5, 0, '2020-11-17 09:34:02'),
(1, 8, 'นักศึกษาสาขาวิชาอุตสาหกรรมศิลป์ ทำความดีด้วยหัวใจ.jpg', '', 'jpg', 6, 0, '2020-11-17 09:39:26'),
(1, 9, 'โครงการปัจฉิมนิเทศนักศึกษาคณะเทคโนโลยีอุตสาหกรรม 63.jpg', '', 'jpg', 7, 0, '2020-11-17 09:40:39'),
(1, 10, 'คณะเทคโนโลยีอุตสาหกรรม มร.ลป. ร่วมหารือเตรียม MOU พัฒนายกระดับชุมชนท้องถิ่น.jpg', '', 'jpg', 8, 0, '2020-11-17 09:42:12'),
(1, 11, 'กิจกรรมจิตอาสา เราทำความดี เพื่อชาติ ศาสน์ กษัตริย์.jpg', '', 'jpg', 9, 0, '2020-11-17 09:45:34'),
(1, 12, 'ประชุมหารือการจัดตั้งศูนย์อบรมและศูนย์ทดสอบฝีมือแรงงาน.jpg', '', 'jpg', 10, 0, '2020-11-17 09:50:29'),
(1, 13, 'เผยแพร่ 5 บทเรียนออนไลน์.jpg', '', 'jpg', 11, 0, '2020-11-17 09:52:12'),
(1, 14, 'กำหนดจัดงานเกษียณอายุราชการ ประจำปี 2563.jpg', '', 'jpg', 12, 0, '2020-11-17 09:55:45'),
(1, 15, 'เปิดรับสมัครนักศึกษาใหม่ ประจำปีการศึกษา 2564.jpg', '', 'jpg', 13, 0, '2020-11-17 09:59:08'),
(1, 16, 'แจ้งนักศึกษาชั้นปีที่ 1 รหัส 63.jpg', '', 'jpg', 14, 0, '2020-11-17 10:05:50'),
(1, 17, 'ศูนย์ถ่ายทอดเทคโนโลยีและวิศวกรรม.jpg', '', 'jpg', 15, 0, '2020-11-17 10:09:48'),
(1, 18, 'กิจกรรมออกร้านขายของ.jpg', '', 'jpg', 16, 0, '2020-11-17 10:12:04'),
(1, 19, 'ร่วมบริจาคโลหิต.jpg', '', 'jpg', 17, 0, '2020-11-17 10:13:59'),
(1, 20, 'งานประเพณียี่เป็ง ณ หนองหัวหงอก ครั้งที่ 11.jpg', '', 'jpg', 18, 0, '2020-11-17 10:16:12');
...
(1, '', '', '2020-11-11 19:03:30', '', 4, 'news', 0);
...
CREATE TABLE `member` (
  ...
  `mem_add_num` varchar(30) NOT NULL,
  `mem_add_street` varchar(50) NOT NULL,
  `mem_add_province_id` int(2) NOT NULL,
  `mem_add_amphure_id` int(4) NOT NULL,
  `mem_add_district_id` int(4) NOT NULL,
  `mem_add_zipcode` varchar(6) NOT NULL,
  `mem_contact` varchar(50) NOT NULL,
  `mem_startdate` date NOT NULL,
  `mem_username` varchar(15) NOT NULL,
  `mem_password` varchar(64) NOT NULL,
  `mem_status` varchar(1) NOT NULL,
  `mem_created` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `mem_updated` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  `mem_email` varchar(64) NOT NULL,
  `mem_job` varchar(50) NOT NULL,
  `mem_work_place` varchar(128) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `member` (`mem_id`, `mem_prename`, `mem_firstname`, `mem_lastname`, `mem_gender`, `mem_birth`, `mem_code`, `mem_add_num`, `mem_add_street`, `mem_add_province_id`, `mem_add_amphure_id`, `mem_add_district_id`, `mem_add_zipcode`, `mem_contact`, `mem_startdate`, `mem_username`, `mem_password`, `mem_status`, `mem_created`, `mem_updated`, `mem_email`, `mem_job`, `mem_work_place`) VALUES
(1, 'Mr.', 'พชร', 'นันทอาภา', '1', '1993-11-01', '1529900668255', '414', '4', 0, 0, 0, '52130', 'test', '2020-10-15', 'test', '$2y$10$EROLR5CseZiIv3plYv4AbeTH5aXgTVVEuxepygDVec4Vs8yb5fUIK', '1', '2020-10-15 12:24:46', NULL, '', '', ''),
(2, 'Ms.', 'แพรวพราว', 'ใจดี', '2', '1999-10-09', '1529900906333', '455 ม.6', '-', 0, 0, 0, '52000', '-', '2020-10-15', 'gungun', '$2y$10$Jd3O/jV4tHCvUOoUoU3R4.JtdffZQ9B1zLat1oFEAI4EoFOZPxupO', '1', '2020-10-15 16:44:27', '2020-10-16 04:22:29', 'surinthorngun@gmail.com', '', ''),
(3, 'Mr.', 'ธวัชชัย', 'ใหม่มาเมือง', '1', '1997-10-07', '1529948578123', '4 ตรอก 2', 'ราชธรรมพิทักษ์', 56, 792, 711101, '71260', '-', '2020-10-16', 'tuch', '$2y$10$TEMfDM.PfeKJi03R7/SntOOhIpQTKaHvjs/DprurrL3ihWhUtGs3a', '1', '2020-10-16 05:14:55', '2020-11-17 07:09:22', 'tuchchapon@gmail.com', 'ทดสอบ', '-'),
(4, 'Mr.', 'นราธิป', 'จันทร์ทิป', '1', '1989-10-18', '1589900092605', '4 ตรอก 2 ', 'ราชธรรมพิทักษื', 0, 0, 0, '58000', '-', '2020-10-19', 'tuchy', '$2y$10$YjDB1VrQc10ftPGAZGx11OG0AAmWw7rkn3ykStoA4cicdYAqabNge', '1', '2020-10-19 03:05:57', '2020-10-19 03:16:41', '-', '', ''),
(5, 'Mr.', 'ทดสอบ', 'อิอิ', '1', '2020-10-05', '1529900906457', '451 ม.3', '-', 0, 0, 0, '52000', '-', '2020-10-19', 'gun', '$2y$10$3Z.Ybb9tex12L9Ec7SkEnuRZnMnbm6bW0laRaO0AJALM.qNbfQ8XW', '0', '2020-10-19 04:53:23', NULL, 'surinthorngun@gmail.com', '', ''),
(7, 'Mr.', 'ทดสอบ', 'ทดสอบ', '1', '2020-11-17', '1529900906444', 'ทดสอบ', 'ทดสอบ', 64, 867, 810402, '81120', 'ทดสอบ', '2020-11-17', 'gun1234', '$2y$10$7jhVHFOW5/TsgdVs2xynneJba1dGmpbD0Ark0JemoH.CtDaMOeIHq', '1', '2020-11-17 06:41:33', '2020-11-17 06:42:04', 'gun@gmail.com', 'ทดสอบ', 'ทดสอบ');
...
CREATE TABLE `member_register` (
  `mem_id` int(10) NOT NULL,
  `reg_course_id` varchar(10) NOT NULL,
  `reg_open_id` int(11) NOT NULL,
  `reg_date` date NOT NULL,
  `reg_status` varchar(1) NOT NULL,
  `reg_pay_status` int(1) NOT NULL,
  `reg_slip` varchar(128) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `member_register` (`mem_id`, `reg_course_id`, `reg_open_id`, `reg_date`, `reg_status`, `reg_pay_status`, `reg_slip`) VALUES
(1, '7', 12, '2020-11-16', '1', 1, 'Slip_12_0001.PNG'),
(3, '7', 12, '2020-11-16', '1', 1, 'Slip_12_0003.png'),
(3, '6', 13, '2020-11-16', '1', 9, ''),
(3, '5', 7, '2020-11-16', '1', 9, ''),
(3, '5', 14, '2020-11-16', '1', 1, 'Slip_14_0003.png'),
(2, '7', 12, '2020-11-17', '0', 2, 'Slip_12_0002.png'),
(2, '6', 13, '2020-11-17', '1', 9, ''),
(7, '7', 12, '2020-11-17', '1', 2, 'Slip_12_0007.png'),
(2, '5', 15, '2021-01-07', '0', 0, '');
...
CREATE TABLE `news` (
  ...
  `new_updated` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  `new_update_id` int(11) NOT NULL,
  `new_viewer` int(11) NOT NULL,
  `new_status` varchar(10) NOT NULL,
  `new_primarylink` varchar(128) NOT NULL
...
INSERT INTO `news` (`new_type_id`, `new_id`, `new_title`, `new_desc`, `new_detail`, `new_image_id`, `new_user_id`, `new_created`, `new_updated`, `new_update_id`, `new_viewer`, `new_status`, `new_primarylink`) VALUES
(2, 5, 'กิจกรรมประดิษฐ์โคมประดับเพื่อบูรณาการ การทำนุบำรุงศิลปวัฒนธรรม', 'กิจกรรมประดิษฐ์โคมประดับเพื่อบูรณาการ การทำนุบำรุงศิลปวัฒนธรรม คณะเทคโนโลยีอุตสาหกรรม', '<p>แจ้งประชาสัมพันธ์ !! กิจกรรม<br />ขอเชิญคณาจารย์ เจ้าหน้าที่ และนักศึกษาเข้าร่วม</p>\r\n<p>กิจกรรมประดิษฐ์โคมประดับเพื่อบูรณาการ<br />การทำนุบำรุงศิลปวัฒนธรรม คณะเทคโนโลยีอุตสาหกรรม</p>\r\n<div class=\"text_exposed_show\">\r\n<p>ในวันพุธที่ 18 พฤศจิกายน 2563<br />เวลา 13.00 - 16.30 น.<br />ณ ห้องประชุมอาคาร (1315) และศาลาอเนกประสงค์<br />คณะเทคโนโลยีอุตสาหกรรม</p>\r\n</div>', 3, 7, '2020-11-17 01:53:52', '2020-11-17 01:54:43', 0, 0, 'enabled', 'กิจกรรมประดิษฐ์โคมประดับเพื่อบูรณาการ-การทำนุบำรุงศิลปวัฒนธรรม'),
(3, 6, 'จัดการสอบคัดเลือกนักศึกษาใหม่ ประจำปีการศึกษา 2564', 'มร.ลป. จัดการสอบคัดเลือกนักศึกษาใหม่ ประจำปีการศึกษา 2564', '<p>มหาวิทยาลัยราชภัฏลำปาง จัดสอบคัดเลือกนักศึกษาใหม่ ประจำปีการศึกษา 2564 ด้วยการสอบข้อเข<span class=\"text_exposed_show\">ียน และสอบสัมภาษณ์วัดแววความเป็นครู เมื่อวันที่ 14 พฤศจิกายน 2563 ณ อาคารโอฬาร โรจน์หิรัญ มหาวิทยาลัยราชภัฏลำปาง</span></p>\r\n<p><span class=\"text_exposed_show\"><img class=\"img\" src=\"/traininglevel/public/photos/c56b6a49aba9e7bb64eb3176252eb19d_87906e7d2c13b2d0b3e7ab0265cadd15.jpg\" alt=\"1.jpg\" width=\"922\" height=\"691.5\" /></span></p>\r\n<p><img class=\"img\" src=\"/traininglevel/public/photos/c56b6a49aba9e7bb64eb3176252eb19d_1c57a242898db02cefad12a5f31099c9.jpg\" alt=\"2.jpg\" width=\"922\" height=\"691.5\" /></p>\r\n<p><img class=\"img\" src=\"/traininglevel/public/photos/c56b6a49aba9e7bb64eb3176252eb19d_4ecfc929781b092a4eceb1b5f1458618.jpg\" alt=\"3.jpg\" width=\"922\" height=\"691.5\" /></p>\r\n<p>&nbsp;</p>\r\n<p>&nbsp;</p>', 4, 7, '2020-11-17 02:03:13', '2020-11-17 02:17:13', 0, 0, 'enabled', 'จัดการสอบคัดเลือกนักศึกษาใหม่-ประจำปีการศึกษา-2564'),
(1, 7, 'มหาวิทยาลัยราชภัฏลำปาง ประกาศรายชื่อผู้มีสิทธิ์สอบ ประเภทสมัครเข้ารับการคัดเลือกเข้าศึกษา รอบที่ 1 ประจำปีการศึกษา 2564', 'มหาวิทยาลัยราชภัฏลำปาง ประกาศรายชื่อผู้มีสิทธิ์สอบ ประเภทสมัครเข้ารับการคัดเลือกเข้าศึกษา รอบที่ 1 ประจำปีการศึกษา 2564 มหาวิทยาลัยราชภัฏลำปาง', '<p>มหาวิทยาลัยราชภัฏลำปาง ประกาศรายชื่อผู้มีสิทธิ์สอบ<br />ประเภทสมัครเข้ารับการคัดเลือกเข้าศึกษา รอบที่ 1<br />ประจำปีการศึกษา 2564 มหาวิทยาลัยราชภัฏลำปาง</p>\r\n<p><span class=\"_5mfr\"><span class=\"_6qdm\">‼️</span></span><span class=\"_5mfr\"><span class=\"_6qdm\">‼️</span></span><span class=\"_5mfr\"><span class=\"_6qdm\">‼️</span></span><span class=\"_5mfr\"><span class=\"_6qdm\">‼️</span></span><span class=\"_5mfr\"><span class=\"_6qdm\">‼️</span></span>รายละเอ<span class=\"text_exposed_show\">ียดเพิ่มเติม<span class=\"_5mfr\"><span class=\"_6qdm\">‼️</span></span><span class=\"_5mfr\"><span class=\"_6qdm\">‼️</span></span><span class=\"_5mfr\"><span class=\"_6qdm\">‼️</span></span><span class=\"_5mfr\"><span class=\"_6qdm\">‼️</span></span><span class=\"_5mfr\"><span class=\"_6qdm\">‼️</span></span><br /><a href=\"http://lprumis.lpru.ac.th/enroll/?fbclid=IwAR1lxFwpgogOXj8nv8tZMSg50UdHxJxd6hjWMteEuP3VxTqpxJtxH2zJSvY\" target=\"_blank\" rel=\"noopener nofollow\" data-ft=\"{&quot;tn&quot;:&quot;-U&quot;}\" data-lynx-mode=\"asynclazy\" data-lynx-uri=\"https://l.facebook.com/l.php?u=http%3A%2F%2Flprumis.lpru.ac.th%2Fenroll%2F%3Ffbclid%3DIwAR1lxFwpgogOXj8nv8tZMSg50UdHxJxd6hjWMteEuP3VxTqpxJtxH2zJSvY&amp;h=AT3khNvxUbC6TO1WOCNcr594ffbwUg3rszFh7-7rCKN5PhC3H81GI-hi7TH7G9wpc9M36hZKxvq9TDSBQQ1xp9282mNdhn4F_b7EB_E_pI_OflJyE3yGqBtN-AuPk3CY0xHAMVjoay3vDwmJ3D2XuWFsT4v6GIncAZA\">http://lprumis.lpru.ac.th/enroll/</a></span></p>\r\n<div class=\"text_exposed_show\">\r\n<p
ักษณ์ ของมหาวิทยาลัยราชภัฏลำปาง<br />\"บัณฑิตจิตอาสา มีคุณธรรม นำสังคม\"</p>\r\n</div>', 5, 7, '2020-11-17 02:21:51', '2020-11-17 02:21:52', 0, 0, 'enabled', 'มหาวิทยาลัยราชภัฏลำปาง-ประกาศรายชื่อผู้มีสิทธิ์สอบ-ประเภทสมัครเข้ารับการคัดเลือกเข้าศึกษา-รอบที่-1-ประจำปีการศึกษา-2564'),
(1, 8, 'การขยายระยะเวลา การรายงานตัวบัณฑิต', 'การขยายระยะเวลา การรายงานตัวบัณฑิต วันที่ 9 - 17 พฤศจิกายน 2563 บัณฑิตที่จะเข้ารับพระราชทานปริญญาบัตรประจำปี 2559 – 2560', '<p>มาแล้วจร้า การขยายระยะเวลา การรายงานตัวบัณฑิต วันที่ 9 - 17 พฤศจิกายน 2563&nbsp;<span class=\"_5mfr\"><span class=\"_6qdm\">????</span></span><span class=\"_5mfr\"><span class=\"_6qdm\">????</span></span><br />เรียน บัณฑิตที่จะเข้ารับพระราชทานปริญญาบัตรประจำปี 2559 &ndash; 2560</p>\r\n<p>ระดับปริญญาตร<span class=\"text_exposed_show\">ีผู้สำเร็จการศึกษา 1 มีนาคม &ndash; 20 ธันวาคม 2560<br />ระดับปริญญาโทและปริญญาเอกผู้สำเร็จการศึกษา 1 มีนาคม &ndash; 14 ธันวาคม 2560<br /></span></p>\r\n<p><span class=\"text_exposed_show\">บัณฑิตสามารถตรวจสอบรายชื่อผู้มีสิทธิ์เข้ารับพระราชทานปริญญาบัตรประจำปี 2559 &ndash; 2560 ทางเว็บไซต์&nbsp;<a href=\"https://l.facebook.com/l.php?u=http%3A%2F%2Fjanphar.lpru.ac.th%2Fcai%2Fcong2563%2Fmainviews.html%3Ffbclid%3DIwAR04ERVbSdWjMcBOv9nNRtn-q5ICPll6pRcSfST173i-Hb2OVbA68xxoy5Q&amp;h=AT0KTOoUCJh-3Juop8-NCc64Aojxpi5okZhWT6Qd4NMfYOoRjZV34T9CAh65a7sfoavl6UJsqPkQ2RomeFDlUN593djjF4Os-qAshMOZc8HeKVCtwBmvNab8WMsbktyg3cuC0iZXy-_cSZ8S7e_bbkNSz_xmiTGToU0\" target=\"_blank\" rel=\"noopener nofollow\" data-ft=\"{\" data-lynx-mode=\"asynclazy\">http://janphar.lpru.ac.th/cai/cong2563/mainviews.html</a><br /><span class=\"_5mfr\"><span class=\"_6qdm\">❤️</span></span>ขณะนี้ทางมหาวิทยาลัยราชภัฏลำปาง ได้ขยายเวลาการเปิดให้รายงานตัวซ้อมรับพระราชปริญญาบัตรดังนี้<br /></span><span class=\"text_exposed_show\">1บัณฑิตทุกคนจะต้องเข้าเว็บ&nbsp;<a href=\"https://l.facebook.com/l.php?u=http%3A%2F%2Flprumis.lpru.ac.th%2FEnd%2F%3Ffbclid%3DIwAR1y15thN9Hpg9Ib8j87ADDD3ouWKCW180Fjxx8_ZpOErvNb-xG4UAJpe18&amp;h=AT1Nxg-1MuMHeQnoKrARGxvUtCvqbeHD21OJDyio1YNogI4UXDtMh2R9JNVKrzcg3-4h_iXlXvZCFJ7hH1t5AIKmrK19nmkLRwJ0WO1gvPn3fn_nKkQbWAFMKIAo7wxfYHc7hZLOJmZEpkJow2q1EC_MtbkJ-WVGh6Y\" target=\"_blank\" rel=\"noopener nofollow\" data-ft=\"{\" data-lynx-mode=\"asynclazy\">http://lprumis.lpru.ac.th/End/</a>&nbsp;เพื่อเข้าสู่ระบบภาวะการมีงานทำของบัณฑิต คลิก &ldquo;สำหรับนักศึกษา&rdquo;<br /></span></p>\r\n<p><span class=\"text_exposed_show\">2.เมื่อทำรายการเสร็จสิ้นในข้อที่ 1 บัณฑิตทุกคนจะต้องเข้าเว็บ&nbsp;<a href=\"http://janphar.lpru.ac.th/cai/cong2563?fbclid=IwAR2hu5mHh1l49qKmaNlOiFlDp6A9g0ETGf5oVO4oEKkPRIHckRhUc2DYVxI\" target=\"_blank\" rel=\"noopener nofollow\" data-ft=\"{\" data-lynx-mode=\"async\" data-lynx-uri=\"https://l.facebook.com/l.php?u=http%3A%2F%2Fjanphar.lpru.ac.th%2Fcai%2Fcong2563%3Ffbclid%3DIwAR2hu5mHh1l49qKmaNlOiFlDp6A9g0ETGf5oVO4oEKkPRIHckRhUc2DYVxI&amp;h=AT1G_v54VTyCQUVwPjDq5C-_rATgsSvwmQ1QKbrctxIhjxHiadYoD1eAhwbzy4LbqkrkL8Ukgpoa61BlsALMSxpYtJeYYS_a6E7LZs7EwXXJlQGXn7tgmA-gLAQ1sH8G8mRoA4qLXmHZ0At8zs_DKwm3PKht3bKDVZXBH8-fsFfFUpdH\">http://janphar.lpru.ac.th/cai/cong2563</a>&nbsp;เพื่อรายงานตัวเข้าฝึกซ้อมพิธีรับพระราชทานปริญญาบัตร ยืนยันข้อมูล พร้อมพิมพ์เอกสาร เพื่อนำไปชำระเงินผ่านเคาน์เตอร์เซอร์วิส ระหว่างวันที่ 9 &ndash; 17 พฤศจิกายน 2563 พร้อมเก็บเอกสารหลักฐานการชำระเงิน<br /><span class=\"_5mfr\"><span class=\"_6qdm\">????</span></span>กรณี บัณฑิตที่ได้รายงานตัวเข้ารับพระราชทานปริญญาบัตรเรียบร้อย และยังไม่ได้ชำระเงิน สามารถนำเอกสารที่พิมพ์เรียบร้อยแล้ว นำไปชำระผ่านเคาน์เตอร์เซอร์วิส ตั้งแต่บัดนี้ถึงวันที่ 17 พฤศจิกายน 2563 พร้อมเก็บเอกสารหลักฐานการชำระเงิน</span></p>\r\n<p><span class=\"text_exposed_show\">3.การรับชุดครุยวิทยะฐานะ บัณฑิตสามารถติดต่อรับชุดครุยได้ด้วยตนเอง ที่มหาวิทยาลัยราชภัฏลำปาง&nbsp;<span class=\"_5mfr\"><span class=\"_6qdm\">????</span></span>ระหว่างวันที่ 5 &ndash; 6 ธันวาคม 2563<br />หมายเหตุ : หากบัณฑิตท่านใดมีคำถามหรือข้อสงสัย โปรดติดต่องานประชาสัมพันธ์ มหาวิทยาลัยราชภัฏลำปาง&nbsp;<span class=\"_5mfr\"><span class=\"_6qdm\">☎️</span></span>&nbsp;054 &ndash; 237 - 399 ต่อ 0 ในวันและเวลาราชการ ตั้งแต่เวลา 08.30 &ndash; 16.30 น.<br /><a class=\"_58cn\" href=\"https://www.facebook.com/hashtag/%E0%B8%A3%E0%B8%B2%E0%B8%8A%E0%B8%A0%E0%B8%B1%E0%B8%8F%E0%B8%A5%E0%B8%B3%E0%B8%9B%E0%B8%B2%E0%B8%87%E0%B8%A3%E0%B9%88%E0%B8%A7%E0%B8%A1%E0%B9%83%E0%B8%88%E0%B8%81%E0%B9%89%E0%B8%B2%E0%B8%A7%E0%B8%AA%E0%B8%B9%E0%B9%88%E0%B8%9B%E0%B8%B5%E0%B8%97%E0%B8%B5%E0%B9%8850%E0%B8%AD%E0%B8%A2%E0%B9%88%E0%B8%B2%E0%B8%87%E0%B8%AA%E0%B8%94%E0%B9%83%E0%B8%AA%E0%B9%81%E0%B8%A5%E0%B8%B0%E0%B8%AA%E0%B8%A3%E0%B9%89%E0%B8%B2%E0%B8%87%E0%B8%AA%E0%B8%A3%E0%B8%A3%E0%B8%84%E0%B9%8C?source=feed_text&amp;epa=HASHTAG\" type=\"\" data-ft=\"{\"><span class=\"_5afx\"><span class=\"_58cl _5afz\" aria-label=\"แฮชแท็ก\">#</span><span class=\"_58cm\">ราชภัฏลำปางร่วมใจก้าวสู่ปีที่50อย่างสดใสและสร้างสรรค์</span></span></a></span></p>', 6, 7, '2020-11-17 02:26:33', '2020-11-17 02:28:52', 0, 0, 'enabled', 'การขยายระยะเวลา-การรายงานตัวบัณฑิต'),
(1, 9, 'กำหนดการส่งเอกสาร กยศ. ภาคเรียนที่ 2/2563', 'งานกองทุนเงินให้กู้ยืมเงินเพื่อการศึกษา (กยศ.) กำหนดการส่งแบบความประสงค์ขอกู้ยืมเงินและเอกสารประกอบ ภาคเรียนที่ 2 ปีการศึกษา 2563 ', '<p>งานกองทุนเงินให้กู้ยืมเงิน<wbr />เพื่อการศึกษา (กยศ.) กำหนดการส่งแบบความประสงค์ข<wbr />อกู้ยืมเงินและเอกสารประกอบ<wbr />&nbsp;ภาคเรียนที่ 2 ปีการศึกษา 2563 ในระหว่างวันที่ 2 &ndash; 4 พฤศจิกายน 2563 ผ่านระบบออนไลน์ (LPRULOAN)&nbsp;<a href=\"https://l.facebook.com/l.php?u=http%3A%2F%2Fmis.lpru.ac.th%2F%3Ffbclid%3DIwAR3eCkcXXJfkqHqiGziEBZ3yYuaXg8eE-LpNJXOyaob17EhOULeFXVzNt1g&amp;h=AT3YHGhae7Shm8KrN3mYJyWfikmA-GH7825WeLG0hdZhWJ1wNgA2XQlLqTDjEThJyEo-5UieTlpCosXgBGuJcujBLTSMF2519delOQfBLaKoXiqTTvH-tzJCYb7I9zN_DhwMv-vbgw\" target=\"_blank\" rel=\"nofollow noopener\" data-lynx-mode=\"asynclazy\">http://mis.lpru.ac.th/</a><br /><br />จึงแจ้งมาเพื่อให้นักศึกษาเ<wbr />ตรียมความพร้อมและดำเนินการ</p>', 7, 7, '2020-11-17 02:34:02', '2020-11-17 02:34:03', 0, 0, 'enabled', 'กำหนดการส่งเอกสาร-กยศ-ภาคเรียนที่-22563'),
(3, 10, 'นักศึกษาสาขาวิชาอุตสาหกรรมศิลป์ ทำความดีด้วยหัวใจ', 'นักศึกษาสาขาวิชาอุตสาหกรรมศิลป์ ทำความดีด้วยหัวใจ บริการตัดผมให้น้องๆเด็กนักเรียน ณ โรงเรียนวัดหลวงวิทยา', '<p>นักศึกษาสาขาวิชาอุตสาหกรรมศิลป์ ทำความดีด้วยหัวใจ<br />บริการตัดผมให้น้องๆเด็กนักเรียน<br />ณโรงเรียนวัดหลวงวิทยา<br /><a class=\"_58cn\" href=\"https://www.facebook.com/hashtag/%E0%B8%84%E0%B8%A3%E0%B8%B9%E0%B8%AD%E0%B8%B8%E0%B8%95%E0%B8%AA%E0%B8%B2%E0%B8%AB%E0%B8%81%E0%B8%A3%E0%B8%A3%E0%B8%A1%E0%B8%A8%E0%B8%B4%E0%B8%A5%E0%B8%9B%E0%B9%8C%E0%B8%AA%E0%B8%A3%E0%B9%89%E0%B8%B2%E0%B8%87%E0%B8%8A%E0%B8%B2%E0%B8%95%E0%B8%B4?source=feed_text&amp;epa=HASHTAG\" data-ft=\"{&quot;type&quot;:104,&quot;tn&quot;:&quot;*N&quot;}\"><span class=\"_5afx\"><span class=\"_58cl _5afz\" aria-label=\"แฮชแท็ก\">#</span><span class=\"_58cm\">ครูอุตสาหกรรมศิลป์สร้างชาติ</span></span></a><br />สนใจเรียนต่อต่อสอบถามได้ครับ</p>', 8, 7, '2020-11-17 02:39:26', '2020-11-17 02:39:27', 0, 0, 'enabled', 'นักศึกษาสาขาวิชาอุตสาหกรรมศิลป์-ทำความดีด้วยหัวใจ'),
(3, 11, 'โครงการปัจฉิมนิเทศนักศึกษาคณะเทคโนโลยีอุตสาหกรรม ประจำปีการศึกษา 2563', 'ผศ.จักรกฤษณ์ ฮั่นยะลา คณบดีคณะเทคโนโลยี เป็นประธานเปิดโครงการปัจฉิมนิเทศนักศึกษาคณะเทคโนโลยีอุตสาหกรรม ประจำปีการศึกษา 2563', '<p>วันพุธที่ 14 ตุลาคม 2563<br />ผศ.จักรกฤษณ์ ฮั่นยะลา คณบดีคณะเทคโนโลยี<br />เป็นประธานเปิดโครงการปัจฉิมนิเทศนักศึกษาคณะเทคโนโลยีอุตสาหกรรม ประจำปีการศึกษา 2563<br />โดยได้รับเกียรติจาก คุณประสงค์ สิทธิจู (พนักงานปฏิบัติการก๊าซ บริษัท ปตท.น้ำมันและการค้าปลีก จำกัด)<br />บรรยายให้ความรู้ในหัวข้อ เส้นทางอาชีพหลังสำเร็จการศึกษา</p>\r\n<div class=\"text_exposed_show\">\r\n<p>และ อาจารย์เมธาวัตน์ กาวิลเครือ (อาจารย์ประจำสาขาวิศวกรรมคอมพิวเตอร์)<br />บรรยายให้ความรู้ในหัวข้อ &ldquo;การเตรียมความพร้อมในการเข้ารับพระราชทานปริญญาบัตรหลังสำเร็จการศึกษา &rdquo;</p>\r\n<p>ณ ห้องประชุมสลุงคำ อาคารศูนย์คอมพิวเตอร์ มหาวิทยาลัยราชภัฏลำปาง<br /><a class=\"_58cn\" href=\"https://www.facebook.com/hashtag/%E0%B8%A3%E0%B8%B2%E0%B8%8A%E0%B8%A0%E0%B8%B1%E0%B8%8F%E0%B8%A5%E0%B8%B3%E0%B8%9B%E0%B8%B2%E0%B8%87%E0%B8%81%E0%B9%89%E0%B8%B2%E0%B8%A7%E0%B8%AA%E0%B8%B9%E0%B9%88%E0%B8%9B%E0%B8%B5%E0%B8%97%E0%B8%B5%E0%B9%8850%E0%B8%AD%E0%B8%A2%E0%B9%88%E0%B8%B2%E0%B8%87%E0%B8%AA%E0%B8%94%E0%B9%83%E0%B8%AA%E0%B9%81%E0%B8%A5%E0%B8%B0%E0%B8%AA%E0%B8%A3%E0%B9%89%E0%B8%B2%E0%B8%87%E0%B8%AA%E0%B8%A3%E0%B8%A3%E0%B8%84%E0%B9%8C?source=feed_text&amp;epa=HASHTAG\" type=\"\" data-ft=\"{\"><span class=\"_5afx\"><span class=\"_58cl _5afz\" aria-label=\"แฮชแท็ก\">#</span><span class=\"_58cm\">ราชภัฏลำปางก้าวสู่ปีที่50อย่างสดใสและสร้างสรรค์</span></span></a></p>\r\n</div>', 9, 7, '2020-11-17 02:40:39', '2020-11-17 02:53:33', 0, 0, 'enabled', 'โครงการปัจฉิมนิเทศนักศึกษาคณะเทคโนโลยีอุตสาหกรรม-ประจำปีการศึกษา-2563'),
(3, 12, 'มร.ลป. ร่วมหารือเตรียม MOU พัฒนายกระดับชุมชนท้องถิ่น', 'คณะเทคโนโลยีอุตสาหกรรม มร.ลป. ร่วมหารือเตรียม MOU พัฒนายกระดับชุมชนท้องถิ่น', '<p>คณะเทคโนโลยีอุตสาหกรรม มร.ลป. ร่วมหารือเตรียม MOU พัฒนายกระดับชุมชนท้องถิ่น</p>\r\n<p>LPRU News : ผศ.จักรกฤษณ์ ฮั่นยะลา คณบดีคณะเทคโนโลยีอุตสาหกรรม มหาวิทยาลัยราชภัฏลำปาง<span class=\"text_exposed_show\">&nbsp;พร้อมด้วยคณะผู้บริหาร ร่วมประชุมหารือร่วมกับ นายนิมิตร สาคำ นายกองค์การบริหารส่วนตำบลบ้านปวง อำเภอทุ่งหัวช้าง จังหวัดลำพูน เพื่อเตรียมการและวางแนวทางการจัดทำบันทึกข้อตกลงความร่วมมือ (MOU) ระหว่างหน่วยงาน ในด้านวิชาการ ด้านการบริการวิชาการ และด้านงานวิจัย เพื่อการส่งเสริม สนับสนุน และพัฒนายกระดับชุมชนท้องถิ่น ภายใต้ยุทธศาสตร์ราชภัฏเพื่อการพัฒนาท้องถิ่น เมื่อวันที่ 14 ตุลาคม 2563 ณ ห้องประชุมองค์การบริหารส่วนตำบลบ้านปวง ตำบลทุ่งหัวช้าง จังหวัดลำพูน</span></p>\r\n<div class=\"text_exposed_show\">\r\n<p>Link Website: งานประชาสัมพันธ์ มหาวิทยาลัยราชภัฏลำปาง<br /><a href=\"https://l.facebook.com/l.php?u=http%3A%2F%2Fwww.pr.lpru.ac.th%2Fmember%2Fupimg.php%3Fid_pic%3D1012%26fbclid%3DIwAR1Fm_uA8NFpNegnKhMoLg1l4eBYCwIvGRawHsd02qmOdo9TNbn2FXj1Qwo&amp;h=AT0-ydpMfGj9yr-fQT-0te60Kjy0JLraMlYzSmJuik4GkTIIRp0P5cdULk0tOVOqtC5aj9Nucy1cnFBxIMOFDFx4X8xmOopq8MpDQ_xZPdhubACr7dxZDiLrItr971ufX-fpg1atphDpPnkaVKKz0zG43Z5eatPFyELMC_oDvYb9a6uEsB3lPbh4Q9M4risCgho9K0A5iTVLjF9s0YNOZ8Mha4RT578tA8QuE4uuxKSpWGcgUo1s086M35CHa-Ai6PT_37ky0JuEccU_rPCThCLBPFVLDAhi3wCjL9xugZ3_P1NRkzx3ygcb43B0GD-v52kYZiBemM_L0a8wbebfs4FrZLGCZ7KU32CZKfew4hns8r61Tq_6QoOm2E1qKTeJ6zFg-kSDDFBFxr0JQ4mEuw-gqUDG3Oimy0maZZNCsE7aooiIbsRxgyeQknTDnazSMwhORAmNVawn7Sf1fvnxx5fCWpC3pcFpvLyKJV_C9VzLinWUab_GDvQovrzWbCJTfoqGwaxMraguENXXSWPb51k3A2U87U7GktDrImwt1XHpkmY7Q1NmnfRJFi7-_O81DIb7vT6cDl5l_gWSeVXNwlGkt9uuAKE6rrqPngKYoeeUv1QI0HOzcpzH1PbqWFsgrEa5VOrE\" target=\"_blank\" rel=\"noopener nofollow\" data-ft=\"{\" data-lynx-mode=\"async\">http://www.pr.lpru.ac.th/member/upimg.php?id_pic=1012</a></p>\r\n<p><a class=\"_58cn\" href=\"https://www.facebook.com/hashtag/%E0%B8%A3%E0%B8%B2%E0%B8%8A%E0%B8%A0%E0%B8%B1%E0%B8%8F%E0%B8%A5%E0%B8%B3%E0%B8%9B%E0%B8%B2%E0%B8%87%E0%B8%81%E0%B9%89%E0%B8%B2%E0%B8%A7%E0%B8%AA%E0%B8%B9%E0%B9%88%E0%B8%9B%E0%B8%B5%E0%B8%97%E0%B8%B5%E0%B9%8850%E0%B8%AD%E0%B8%A2%E0%B9%88%E0%B8%B2%E0%B8%87%E0%B8%AA%E0%B8%94%E0%B9%83%E0%B8%AA%E0%B9%81%E0%B8%A5%E0%B8%B0%E0%B8%AA%E0%B8%A3%E0%B9%89%E0%B8%B2%E0%B8%87%E0%B8%AA%E0%B8%A3%E0%B8%A3%E0%B8%84%E0%B9%8C?source=feed_text&amp;epa=HASHTAG&amp;__xts__%5B0%5D=68.ARBKAmDy3dy4ZSao7lqfifB-yvdIgtAkOmKCXaxoKuozaw1isNo0H0utBqaJ5VFIrcJK0aHcYZgWC8veVLqeS_isWnicNdZ75nVJqP3oJ2KHA33rNujy-AdOojS1wWt5wXiiMY7EMCHFxDZ667uRv0BGMrYPcD0-FJ_P_NaBcIljSGeMK9slKImKvtuKA6BKcUQjBQTGUX2m3PI3xlm7KrPjUzJjREkaKe3P--FGSlQCSFY8HigqeP6OeZLuiLK3-Z2h2-NMJKDpjsaABYgKEmn6dSA3mxuUP4QFuhhIrUIWFCjjxaiomuAtzpcf6MAkSX3Gc7ESRB8tXg2W7yczrElNV8c&amp;__tn__=%2ANKH-R\" type=\"\" data-ft=\"{\"><span class=\"_5afx\"><span class=\"_58cl _5afz\" aria-label=\"แฮชแท็ก\">#</span><span class=\"_58cm\">ราชภัฏลำปางก้าวสู่ปีที่50อย่างสดใสและสร้างสรรค์</span></span></a></p>\r\n</div>', 10, 7, '2020-11-17 02:42:12', '2020-11-17 02:52:50', 0, 0, 'enabled', 'มรลป-ร่วมหารือเตรียม-mou-พัฒนายกระดับชุมชนท้องถิ่น'),
(3, 13, 'กิจกรรมจิตอาสา ', 'รศ.ดร.กิตติศักดิ์ สมุทธารักษ์ อธิการบดีมหาวิทยาลัยราชภัฏลำปาง พร้อมด้วยผู้บริหาร คณาจารย์ เจ้าหน้า นักศึกษา และสมาชิกจิตอาสาพระราชทาน ได้จัดกิจกรรมจิตอาสา ', '<p>LPRU News : เมื่อวันที่ 12 ตุลาคม 2563 เวลา 10.00น. รศ.ดร.กิตติศักดิ์ สมุทธารักษ์ อธิการบดีมหาวิทยาลัยราชภัฏลำปาง พร้อมด้วยผู้บริหาร คณาจารย์ เจ้าหน้า นักศึกษา&nbsp;<span class=\"text_exposed_show\">และสมาชิกจิตอาสาพระราชทาน ได้จัดกิจกรรมจิตอาสา \"เราทำความดี เพื่อชาติ ศาสน์ กษัตริย์\" เนื่องในวันสวรรคตพระบาทสมเด็จพระบรมชนกาธิเบศร มหาภูมิพลอดุลยเดชมหาราช บรมนาถบพิตร</span></p>\r\n<div class=\"text_exposed_show\">\r\n<p>โดยมุ่งเน้นกิจกรรมการพัฒนาสิ่งแวดล้อม จัดเก็บขยะ และกำจัดวัชพืช ตลอดจนการปลูกต้นไม้ บริเวณโดยรอบ ณ อุทยานวิถีพอเพียง คณะเทคโนโลยีการเกษตร มหาวิทยาลัยราชภัฏลำปาง โดยมีสมาชิกจิตอาสาพระราชทาน สังกัดมหาวิทยาลัยราชภัฏลำปาง ร่วมกิจกรรมกว่า 100 คน</p>\r\n<p><a class=\"_58cn\" href=\"https://www.facebook.com/hashtag/%E0%B8%A3%E0%B8%B2%E0%B8%8A%E0%B8%A0%E0%B8%B1%E0%B8%8F%E0%B8%A5%E0%B8%B3%E0%B8%9B%E0%B8%B2%E0%B8%87%E0%B8%A3%E0%B9%88%E0%B8%A7%E0%B8%A1%E0%B9%83%E0%B8%88%E0%B8%81%E0%B9%89%E0%B8%B2%E0%B8%A7%E0%B8%AA%E0%B8%B9%E0%B9%88%E0%B8%9B%E0%B8%B5%E0%B8%97%E0%B8%B5%E0%B9%8850%E0%B8%AD%E0%B8%A2%E0%B9%88%E0%B8%B2%E0%B8%87%E0%B8%AA%E0%B8%94%E0%B9%83%E0%B8%AA%E0%B9%81%E0%B8%A5%E0%B8%B0%E0%B8%AA%E0%B8%A3%E0%B9%89%E0%B8%B2%E0%B8%87%E0%B8%AA%E0%B8%A3%E0%B8%A3%E0%B8%84%E0%B9%8C?source=feed_text&amp;epa=HASHTAG&amp;__xts__%5B0%5D=68.ARAztQT2s4YBUj6IqWWovsWzhHOjiwMKoKQgmgEiGBh0-nOiVkpW885t_OTg9aOCAVPmdtSYWj7fT8Sm-h9s3RxnRuZrHO9Ron2MDjHlPRhfLenp8HSp9CYjNBsXCPYdvvZ_v05thzJxzVQ4nmwC4_cZpVU1ecc5WVoEwqrP-wiJd7gIwf_R4EfnQtF1oAx_UfiXCBCw5cBshJ9DyZ8YDD9gSTL09GpbyGok78HDXzP5tG9G-RJZQmNq6ZOSAmM94xkJxwgepOQt-g8AEgdHm7WmalNwf3L9Xw7bSkj8mfX03pjaYKZLQh61OtVgRybdAM6q13oJemei_1h0fWl9P8PKbOg&amp;__tn__=%2ANKH-R\" type=\"\" data-ft=\"{\"><span class=\"_5afx\"><span class=\"_58cl _5afz\" aria-label=\"แฮชแท็ก\">#</span><span class=\"_58cm\">ราชภัฏลำปางร่วมใจก้าวสู่ปีที่50อย่างสดใสและสร้างสรรค์</span></span></a></p>\r\n</div>', 11, 7, '2020-11-17 02:45:34', '2020-11-17 02:46:22', 0, 0, 'enabled', 'กิจกรรมจิตอาสา'),
(3, 14, 'ประชุมหารือการจัดตั้งศูนย์อบรมและศูนย์ทดสอบฝีมือแรงงาน', 'คณะเทคโนโลยีอุตสาหกรรม มร.ลป. ประชุมหารือการจัดตั้งศูนย์อบรมและศูนย์ทดสอบฝีมือแรงงาน', '<p>คณะเทคโนโลยีอุตสาหกรรม มร.ลป. ประชุมหารือการจัดตั้งศูนย์อบรมและศูนย์ทดสอบฝีมือแรงงาน</p>\r\n<p>LPRU News : เมื่อวันที่ 8 ตุลาคม 2563 ผศ.จักรกฤษณ์ ฮั่นยะลา คณบดีคณะเทคโ<span class=\"text_exposed_show\">นโลยีอุตสาหกรรม มหาวิทยาลัยราชภัฏลำปาง ประชุมหารือร่วมกับนางสาวหญิงแรก กันชู หัวหน้ากลุ่มงานมาตรฐานฝีมือแรงงาน นายปิยะ เสนานุช นักวิชาการพัฒนาฝีมือแรงงานชำนาญการ และว่าที่ร้อยตรี สมพงษ์ สาบุบผา นักวิชาการพัฒนาฝีมือแรงงานปฏิบัติการ สถาบันพัฒนาฝีมือแรงงานภาค 10 ลำปาง เพื่อร่วมหารือการจัดตั้งศูนย์อบรมพัฒนาฝีมือแรงงานวิชาชีพเฉพาะด้านอุตสาหกรรม พร้อมจัดทดสอบฝีมือแรงงาน ณ ห้องประชุมชั้น 1 คณะเทคโนโลยีอุตสาหกรรม มหาวิทยาลัยราชภัฏลำปาง</span></p>\r\n<div class=\"text_exposed_show\">\r\n<p>การจัดการประชุมในครั้งนี้ เป็นการพิจารณารายละเอียดของมาตรฐานฝีมือแรงงานในแต่ละสาขา จำนวน 261 รายการ ตามที่ได้ประกาศในราชกิจจานุเบกษา โดยสถาบันพัฒนาฝีมือแรงงานภาค 10 ได้ชี้แจงหลักเกณฑ์การจัดตั้งศูนย์ทดสอบมาตรฐานฝีมือแรงงานแห่งชาติ ซึ่งคณะเทคโนโลยีอุตสาหกรรม มหาวิทยาลัยราชภัฏลำปาง จะได้พิจารณาความพร้อมการจัดอบรมและจัดตั้งศูนย์ทดสอบฝีมือแรงงานในลำดับต่อไป</p>\r\n<p>Link Website: งานประชาสัมพันธ์ มหาวิทยาลัยราชภัฏลำปาง<br /><a href=\"http://www.pr.lpru.ac.th/member/upimg.php?id_pic=1002&amp;fbclid=IwAR29umHBlDbbzCEqmvX2BSnpv4FK4zR6yH4cnEwv025xV9ebEaPeWhl1wK0\" target=\"_blank\" rel=\"noopener nofollow\" data-ft=\"{&quot;tn&quot;:&quot;-U&quot;}\" data-lynx-mode=\"async\" data-lynx-uri=\"https://l.facebook.com/l.php?u=http%3A%2F%2Fwww.pr.lpru.ac.th%2Fmember%2Fupimg.php%3Fid_pic%3D1002%26fbclid%3DIwAR29umHBlDbbzCEqmvX2BSnpv4FK4zR6yH4cnEwv025xV9ebEaPeWhl1wK0&amp;h=AT2nyxGvK-r5m90SmYWcfqrNvafp1MZYei2VR_9tkj7tVUt0-L9H27PfqUIPDPgpFa26ev3ziRY7gP1AOYMQeLYgYiZ8pk1Zq4Ldl-krsfp2ak9vuuTC5LRRoaR-G7Lzo20NPAl_3q8DI3grWduodEyctTbVlqKnvn94uZRkm7mCdE0SBEpzjiyc6l0L1P3ep9WV5NGsMhIPW3wuFeIvx5Vnlr6oEfsAPVb3ovmSIebVp-15RxIm4HTp9XKh2oVoaA337-YxJf-mdCVme5q2GMkXc-w2eDI3mXG5utrhzxWkZ_cRh-em8IgpFxJ9jBmJ5JCiXnLjNTLaJnV80Rxblt8x8URLwq1Ham3pgdNMFHZJUIZMVf14N_C4c1uPjrNTzDa_tF6Jhl6IABDP1a8bwFei-NEBZML-XOqd2kjSZhXLWdtGwW8aZ7k35JF5wZy7k2GZQqHIhdMMfRhDWUxhSqd88q2gi0piR-He1ZvOv1GGrCZihFsSxdRWIFPEUyeUqcQXaPFWZpdPGMlMkhU3jzp7-TvMjuC6JZ4UPCPR0FVBM3KlUSXodLJfVVG4GkIeN3UeSoDwlnqJU6oymZpE11GdHed6Hgm7N5szmc5t6mm6I7GIPyBvXTzcMTYAW__tXbN8dIzh\">http://www.pr.lpru.ac.th/member/upimg.php?id_pic=1002</a></p>\r\n<p><a class=\"_58cn\" href=\"https://www.facebook.com/hashtag/%E0%B8%A3%E0%B8%B2%E0%B8%8A%E0%B8%A0%E0%B8%B1%E0%B8%8F%E0%B8%A5%E0%B8%B3%E0%B8%9B%E0%B8%B2%E0%B8%87%E0%B8%A3%E0%B9%88%E0%B8%A7%E0%B8%A1%E0%B9%83%E0%B8%88%E0%B8%81%E0%B9%89%E0%B8%B2%E0%B8%A7%E0%B8%AA%E0%B8%B9%E0%B9%88%E0%B8%9B%E0%B8%B5%E0%B8%97%E0%B8%B5%E0%B9%8850%E0%B8%AD%E0%B8%A2%E0%B9%88%E0%B8%B2%E0%B8%87%E0%B8%AA%E0%B8%94%E0%B9%83%E0%B8%AA%E0%B9%81%E0%B8%A5%E0%B8%B0%E0%B8%AA%E0%B8%A3%E0%B9%89%E0%B8%B2%E0%B8%87%E0%B8%AA%E0%B8%A3%E0%B8%A3%E0%B8%84%E0%B9%8C?source=feed_text&amp;epa=HASHTAG&amp;__xts__%5B0%5D=68.ARBAQ7D4UW7O6-047fOvoYfkxuVtsWmNbxRdmU5LdI3lfLKNiQ6dLffaTfdJWW_Curd6kROgX7k6Bu6yU4xk2NP_ILW-WbA6TBP2dymjhnhoc7YMZW6usDb3sBVhD3AZdGSWh0wc__k40eggkSX7aaxiQL0rikdjZWfvpZWkoIoUslwN66Y-bc8UBEv6ix9j6PcG-9omC10ZRQOMkNIgfBfdWtceMKxeQETCU3xywFYJNTJtx1SMO2pS-G7CWzn4eyA0DRzJvIDgEtSodKuWH5wtiJxXLLZdjxeUdcCM_IBmSCbxD5u4VQ6G876wBeLnqmIz1FIxZmYIMftoQp1hBAYNXVc&amp;__tn__=%2ANKH-R\" data-ft=\"{&quot;type&quot;:104,&quot;tn&quot;:&quot;*N&quot;}\"><span class=\"_5afx\"><span class=\"_58cl _5afz\" aria-label=\"แฮชแท็ก\">#</span><span class=\"_58cm\">ราชภัฏลำปางร่วมใจก้าวสู่ปีที่50อย่างสดใสและสร้างสรรค์</span></span></a></p>\r\n</div>', 12, 7, '2020-11-17 02:50:29', '2020-11-17 02:50:30', 0, 0, 'enabled', 'ประชุมหารือการจัดตั้งศูนย์อบรมและศูนย์ทดสอบฝีมือแรงงาน');
INSERT INTO `news` (`new_type_id`, `new_id`, `new_title`, `new_desc`, `new_detail`, `new_image_id`, `new_user_id`, `new_created`, `new_updated`, `new_update_id`, `new_viewer`, `new_status`, `new_primarylink`) VALUES
(1, 15, 'สำนักวิทยบริการและเทคโนโลยีสารสนเทศ มหาวิทยาลัยราชภัฏลำปาง เผยแพร่ 5 บทเรียนออนไลน์ ', 'สำนักวิทยบริการและเทคโนโลยีสารสนเทศ มหาวิทยาลัยราชภัฏลำปาง เผยแพร่ 5 บทเรียนออนไลน์ สำหรับนักศึกษา บุคลากร หรือผู้สนใจ เข้าร่วมศึกษาออนไลน์', '<p>สำนักวิทยบริการและเทคโนโลยีสารสนเทศ มหาวิทยาลัยราชภัฏลำปาง เผยแพร่ 5 บทเรียนออนไลน์ สำหรับนักศึกษา บุคลากร หรือผู้สนใจ เข้าร่วมศึกษาออนไลน์ สามารถแสกน QR code ไ<span class=\"text_exposed_show\">ด้ที่หน้าหลักสูตร หรือคลิกที่ link นี้</span></p>\r\n<div class=\"text_exposed_show\">\r\n<p><a href=\"http://arit.lpru.ac.th/e-learning/?fbclid=IwAR23FoIZLCMriKqzkFYe65THCnKQCKR9BOSF_A5et8xdrkntZvQGI7FU6nE\" target=\"_blank\" rel=\"noopener nofollow\" data-ft=\"{&quot;tn&quot;:&quot;-U&quot;}\" data-lynx-mode=\"asynclazy\" data-lynx-uri=\"https://l.facebook.com/l.php?u=http%3A%2F%2Farit.lpru.ac.th%2Fe-learning%2F%3Ffbclid%3DIwAR23FoIZLCMriKqzkFYe65THCnKQCKR9BOSF_A5et8xdrkntZvQGI7FU6nE&amp;h=AT2isZVFm-WwXoeVIG0YSad06YGwYAsTGNGAAqPCtShixDLNFiwN0HIw5UU-o8AqimNXrcSWD3oY0vDnCMDg7bNcl4NoxDzvgRM__FxNb4CgluKgGJxAa2_B_ZeHm2Qccae59RpvsqQ_OBqW7_qEriSZd9E1T1I8SwU\">http://arit.lpru.ac.th/e-learning/</a></p>\r\n<p>-----------------------------------------------<br />ติดตามข่าวสารมหาวิทยาลัยราชภัฏลำปางได้ทาง<br />โทร 054-237399<br /><a href=\"https://l.facebook.com/l.php?u=http%3A%2F%2Fwww.lpru.ac.th%2F%3Ffbclid%3DIwAR2fgR7saJQxMJPXaLjmdmj8-F4KT93tGX5AtfAMW1iNPEySmYE4sOJBPZs&amp;h=AT1ZjqdicRqlghygWkX2rBpMyHyqhZR-is4fS9nQlffRqnVt5Bu2n8g1GivpPgiLWRCLezjfpLC-tmC6LjPX2DDPMrOkroPeGefH6LeawBJBHcgwsN-g4vO4sz-82fa4DgeNWshxY-6Ffu7kKfO_sSBAzReAQQNG1ys\" target=\"_blank\" rel=\"noopener nofollow\" data-ft=\"{&quot;tn&quot;:&quot;-U&quot;}\" data-lynx-mode=\"asynclazy\">www.lpru.ac.th</a><br /><a href=\"https://l.facebook.com/l.php?u=http%3A%2F%2Fwww.pr.lpru.ac.th%2F%3Ffbclid%3DIwAR29-zkd1AF6D7MTeJ-QZxZstGMOfGdNH3YDtfaBa--yfPEGQczTY-juMpo&amp;h=AT2ox4u7-KWOGRjsZXf8zU0c0wf0GvNQmnlTsGoUIPWcCZ7zcWltiw6CD7jZBmJbtXUzOe2y5acCbJ-6yXi_OSz3DThMQQRSWLvELLwyprB5hzmnKXOAW7Xk0XjnDX5BjMGIhhFz8Qo1EI0czJOS4ReqPALHLmmDs5k\" target=\"_blank\" rel=\"noopener nofollow\" data-ft=\"{&quot;tn&quot;:&quot;-U&quot;}\" data-lynx-mode=\"asynclazy\">http://www.pr.lpru.ac.th</a><br /><a class=\"profileLink\" title=\"Lampang RajabhatUniversity\" href=\"https://www.facebook.com/LampangRajabhatUniversity?__tn__=%2CdKH-R-R&amp;eid=ARDfiuiEuyUzSDRSoMriPgrqnwmOymT-OK9jJsFCGZo8_KhkjqWjEM-_2cWUx-xAqd88XcE-LBQ5GlW8&amp;fref=mentions\" data-hovercard=\"/ajax/hovercard/user.php?id=100001809958125&amp;extragetparams=%7B%22__tn__%22%3A%22%2CdKH-R-R%22%2C%22eid%22%3A%22ARDfiuiEuyUzSDRSoMriPgrqnwmOymT-OK9jJsFCGZo8_KhkjqWjEM-_2cWUx-xAqd88XcE-LBQ5GlW8%22%2C%22fref%22%3A%22mentions%22%7D\" data-hovercard-prefer-more-content-show=\"1\">https://www.facebook.com/LampangRajabhatUniversity</a><br /><a class=\"profileLink\" href=\"https://www.facebook.com
E0%B9%8C?source=feed_text&amp;epa=HASHTAG\" data-ft=\"{&quot;type&quot;:104,&quot;tn&quot;:&quot;*N&quot;}\"><span class=\"_5afx\"><span class=\"_58cl _5afz\" aria-label=\"แฮชแท็ก\">#</span><span class=\"_58cm\">งานประชาสัมพันธ์</span></span></a>&nbsp;<a class=\"_58cn\" href=\"https://www.facebook.com/hashtag/%E0%B8%87%E0%B8%B2%E0%B8%99%E0%B8%AA%E0%B8%B7%E0%B9%88%E0%B8%AD%E0%B8%AA%E0%B8%B2%E0%B8%A3%E0%B8%AD%E0%B8%87%E0%B8%84%E0%B9%8C%E0%B8%81%E0%B8%A3?source=feed_text&amp;epa=HASHTAG\" data-ft=\"{&quot;type&quot;:104,&quot;tn&quot;:&quot;*N&quot;}\"><span class=\"_5afx\"><span class=\"_58cl _5afz\" aria-label=\"แฮชแท็ก\">#</span><span class=\"_58cm\">งานสื่อสารองค์กร</span></span></a>&nbsp;<a class=\"_58cn\" href=\"https://www.facebook.com/hashtag/news_lpru?source=feed_text&amp;epa=HASHTAG\" data-ft=\"{&quot;type&quot;:104,&quot;tn&quot;:&quot;*N&quot;}\"><span class=\"_5afx\"><span class=\"_58cl _5afz\" aria-label=\"แฮชแท็ก\">#</span><span class=\"_58cm\">news_lpru</span></span></a>&nbsp;<a class=\"_58cn\" href=\"https://www.facebook.com/hashtag/prlpru?source=feed_text&amp;epa=HASHTAG\" data-ft=\"{&quot;type&quot;:104,&quot;tn&quot;:&quot;*N&quot;}\"><span class=\"_5afx\"><span class=\"_58cl _5afz\" aria-label=\"แฮชแท็ก\">#</span><span class=\"_58cm\">PRLPRU</span></span></a>&nbsp;<a class=\"_58cn\" href=\"https://www.facebook.com/hashtag/prlpru2015?source=feed_text&amp;epa=HASHTAG\" data-ft=\"{&quot;type&quot;:104,&quot;tn&quot;:&quot;*N&quot;}\"><span class=\"_5afx\"><span class=\"_58cl _5afz\" aria-label=\"แฮชแท็ก\">#</span><span class=\"_58cm\">prlpru2015</span></span></a>&nbsp;<a class=\"_58cn\" href=\"https://www.facebook.com/hashtag/lprunews?source=feed_text&amp;epa=HASHTAG\" data-ft=\"{&quot;type&quot;:104,&quot;tn&quot;:&quot;*N&quot;}\"><span class=\"_5afx\"><span class=\"_58cl _5afz\" aria-label=\"แฮชแท็ก\">#</span><span class=\"_58cm\">LPRUNEWS</span></span></a>&nbsp;<a class=\"_58cn\" href=\"https://www.facebook.com/hashtag/%E0%B8%A5%E0%B8%B3%E0%B8%9B%E0%B8%B2%E0%B8%87?source=feed_text&amp;epa=HASHTAG\" data-ft=\"{&quot;type&quot;:104,&quot;tn&quot;:&quot;*N&quot;}\"><span class=\"_5afx\"><span class=\"_58cl _5afz\" aria-label=\"แฮชแท็ก\">#</span><span class=\"_58cm\">ลำปาง</span></span></a>&nbsp;<a class=\"_58cn\" href=\"https://www.facebook.com/hashtag/%E0%B9%80%E0%B8%A1%E0%B8%B7%E0%B8%AD%E0%B8%87%E0%B8%A3%E0%B8%96%E0%B8%A1%E0%B9%89%E0%B8%B2?source=feed_text&amp;epa=HASHTAG\" data-ft=\"{&quot;type&quot;:104,&quot;tn&quot;:&quot;*N&quot;}\"><span class=\"_5afx\"><span class=\"_58cl _5afz\" aria-label=\"แฮชแท็ก\">#</span><span class=\"_58cm\">เมืองรถม้า</span></span></a>&nbsp;<a class=\"_58cn\" href=\"https://www.facebook.com/hashtag/%E0%B8%AB%E0%B8%99%E0%B8%AD%E0%B8%87%E0%B8%AB%E0%B8%B1%E0%B8%A7%E0%B8%AB%E0%B8%87%E0%B8%AD%E0%B8%81?source=feed_text&amp;epa=HASHTAG\" data-ft=\"{&quot;type&quot;:104,&quot;tn&quot;:&quot;*N&quot;}\"><span class=\"_5afx\"><span class=\"_58cl _5afz\" aria-label=\"แฮชแท็ก\">#</span><span class=\"_58cm\">หนองหัวหงอก</span></span></a><br /><a class=\"_58cn\" href=\"https://www.facebook.com/hashtag/%E0%B8%9B%E0%B8%A3%E0%B8%B0%E0%B8%81%E0%B8%A7%E0%B8%94%E0%B8%A3%E0%B8%B2%E0%B8%84%E0%B8%B2?source=feed_text&amp;epa=HASHTAG\" data-ft=\"{&quot;type&quot;:104,&quot;tn&quot;:&quot;*N&quot;}\"><span class=\"_5afx\"><span class=\"_58cl _5afz\" aria-label=\"แฮชแท็ก\">#</span><span class=\"_58cm\">ประกวดราคา</span></span></a>&nbsp;<a class=\"_58cn\" href=\"https://www.facebook.com/hashtag/%E0%B8%A3%E0%B8%AD%E0%B8%9A%E0%B8%A3%E0%B8%B1%E0%B9%89%E0%B8%A7?source=feed_text&amp;epa=HASHTAG\" data-ft=\"{&quot;type&quot;:104,&quot;tn&quot;:&quot;*N&quot;}\"><span class=\"_5afx\"><span class=\"_58cl _5afz\" aria-label=\"แฮชแท็ก\">#</span><span class=\"_58cm\">รอบรั้ว</span></span></a>&nbsp;<a class=\"_58cn\" href=\"https://www.facebook.com/hashtag/%E0%B8%A3%E0%B8%B1%E0%B8%9A%E0%B8%AA%E0%B8%A1%E0%B8%B1%E0%B8%84%E0%B8%A3%E0%B8%87%E0%B8%B2%E0%B8%99?source=feed_text&amp;epa=HASHTAG\" data-ft=\"{&quot;type&quot;:104,&quot;tn&quot;:&quot;*N&quot;}\"><span class=\"_5afx\"><span class=\"_58cl _5afz\" aria-label=\"แฮชแท็ก\">#</span><span class=\"_58cm\">รับสมัครงาน</span></span></a>&nbsp;<a class=\"_58cn\" href=\"https://www.facebook.com/hashtag/%E0%B8%A3%E0%B8%B1%E0%B8%9A%E0%B8%AA%E0%B8%A1%E0%B8%B1%E0%B8%84%E0%B8%A3%E0%B8%99%E0%B8%B1%E0%B8%81%E0%B8%A8%E0%B8%B6%E0%B8%81%E0%B8%A9%E0%B8%B2?source=feed_text&amp;epa=HASHTAG\" data-ft=\"{&quot;type&quot;:104,&quot;tn&quot;:&quot;*N&quot;}\"><span class=\"_5afx\"><span class=\"_58cl _5afz\" aria-label=\"แฮชแท็ก\">#</span><span class=\"_58cm\">รับสมัครนักศึกษา</span></span></a>&nbsp;<a class=\"_58cn\" href=\"https://www.facebook.com/hashtag/%E0%B8%99%E0%B8%B1%E0%B8%81%E0%B8%A8%E0%B8%B6%E0%B8%81%E0%B8%A9%E0%B8%B2%E0%B9%83%E0%B8%AB%E0%B8%A1%E0%B9%88?source=feed_text&amp;epa=HASHTAG\" data-ft=\"{&quot;type&quot;:104,&quot;tn&quot;:&quot;*N&quot;}\"><span class=\"_5afx\"><span class=\"_58cl _5afz\" aria-label=\"แฮชแท็ก\">#</span><span class=\"_58cm\">นักศึกษาใหม่</span></span></a>&nbsp;<a class=\"_58cn\" href=\"https://www.facebook.com/hashtag/%E0%B8%82%E0%B9%88%E0%B8%B2%E0%B8%A7%E0%B8%9A%E0%B8%A3%E0%B8%B4%E0%B8%81%E0%B8%B2%E0%B8%A3%E0%B8%A0%E0%B8%B2%E0%B8%A2%E0%B8%99%E0%B8%AD%E0%B8%81?source=feed_text&amp;epa=HASHTAG\" data-ft=\"{&quot;type&quot;:104,&quot;tn&quot;:&quot;*N&quot;}\"><span class=\"_5afx\"><span class=\"_58cl _5afz\" aria-label=\"แฮชแท็ก\">#</span><span class=\"_58cm\">ข่าวบริการภายนอก</span></span></a><br /><a class=\"_58cn\" href=\"https://www.facebook.com/hashtag/%E0%B8%A3%E0%B8%B2%E0%B8%8A%E0%B8%A0%E0%B8%B1%E0%B8%8F%E0%B8%A5%E0%B8%B3%E0%B8%9B%E0%B8%B2%E0%B8%87%E0%B8%A3%E0%B9%88%E0%B8%A7%E0%B8%A1%E0%B9%83%E0%B8%88%E0%B8%81%E0%B9%89%E0%B8%B2%E0%B8%A7%E0%B8%AA%E0%B8%B9%E0%B9%88%E0%B8%9B%E0%B8%B5%E0%B8%97%E0%B8%B5%E0%B9%8850%E0%B8%AD%E0%B8%A2%E0%B9%88%E0%B8%B2%E0%B8%87%E0%B8%AA%E0%B8%94%E0%B9%83%E0%B8%AA%E0%B9%81%E0%B8%A5%E0%B8%B0%E0%B8%AA%E0%B8%A3%E0%B9%89%E0%B8%B2%E0%B8%87%E0%B8%AA%E0%B8%A3%E0%B8%A3%E0%B8%84%E0%B9%8C?source=feed_text&amp;epa=HASHTAG\" data-ft=\"{&quot;type&quot;:104,&quot;tn&quot;:&quot;*N&quot;}\"><span class=\"_5afx\"><span class=\"_58cl _5afz\" aria-label=\"แฮชแท็ก\">#</span><span class=\"_58cm\">ราชภัฏลำปางร่วมใจก้าวสู่ปีที่50อย่างสดใสและสร้างสรรค์</span></span></a></p>\r\n<p>\"ราชภัฏ\"<br />\"คนของพระราชา ข้าของแผ่นดิน\"<br />เอกลักษณ์ ของมหาวิทยาลัยราชภัฏลำปาง<br />\"มหาวิทยาลัยเพื่อการพัฒนาท้องถิ่น\"<br />อัตลักษณ์ ของมหาวิทยาลัยราชภัฏลำปาง<br />\"บัณฑิตจิตอาสา มีคุณธรรม นำสังคม\"<br />---------------------------------------------------</p>\r\n</div>', 13, 7, '2020-11-17 02:52:12', '2020-11-17 02:52:13', 0, 0, 'enabled', 'สำนักวิทยบริการและเทคโนโลยีสารสนเทศ-มหาวิทยาลัยราชภัฏลำปาง-เผยแพร่-5-บทเรียนออนไลน์'),
(1, 16, 'กำหนดจัดงานเกษียณอายุราชการ ประจำปี 2563', 'มหาวิทยาลัยราชภัฏลำปาง กำหนดจัดงานเกษียณอายุราชการ ประจำปี 2563 ในวันที่ 24 กันยายน 2563 ณ หอประชุมจันทน์ผา มหาวิทยาลัยราชภัฏลำปาง', '<p>มหาวิทยาลัยราชภัฏลำปาง กำหนดจัดงานเกษียณอายุราชการ ประจำปี 2563 ในวันที่ 24 กันยายน 2563 ณ หอประชุมจันทน์ผา มหาวิทยาลัยราชภัฏลำปาง<br />โดยมีผู้เกษียณอายุราชการ ดัง<span class=\"text_exposed_show\">นี้<br />1.รศ.สมชัย โกศล รองอธิการบดีฝ่ายวิชาการและอาจารย์สังกัดคณะวิทยาศาสตร์<br />2.ผศ.ยุพา อภิโกมลกร อาจารย์สังกัดคณะวิทยาศาสตร์<br />3.อาจารย์อวัสดา บินโซดาโอะ อาจารย์สังกัดคณะวิทยาการจัดการ<br />4.ผศ.ดร.สุเทพ ทองคำ อาจารย์สังกัดคณะวิทยาการจัดการ<br />5.อาจารย์มยุรี พรหมเทพ อาจารย์สังกัดคณะวิทยาการจัดการ<br />6.อาจารย์แวอีเลียส บินโซดาโอะ อาจารย์สังกัดคณะเทคโนโลยีอุตสาหกรรม<br />7.อาจารย์วีรวัชร พงศ์นภา อาจารย์สังกัดคณะเทคโนโลยีอุตสาหกรรม<br />8.อาจารย์วิธธวัช ปินทะสาย อาจารย์สังกัดคณะมนุษยศาสตร์และสังคมศาสตร์<br />9.นายบรรจง สมศรี ผู้อำนวยการกองพัฒนานักศึกษา<br />10.นางประภา ไชยมงคล หัวหน้าสำนักงานคณบดีคณะวิทยาการจัดการ<br />11.นายมานิต วงศ์เสนาะ สำนักงานอธิการบดี<br />12.นายศรีวรรณ ศรีตาบุตร สำนักงานอธิการบดี<br />13.นายบุญหลง ฝั้นคำอ้าย สำนักงานอธิการบดี<br />14.นายจรัญ อุ่นม่อน คณะเทคโนโลยีอุตสาหกรรม<br />15.นายเรืองฤทธิ์ สีตาบุตร สำนักงานอธิการบดี</span></p>\r\n<div class=\"text_exposed_show\">\r\n<p>จึงขอเรียนเชิญทุกท่านร่วมมุทิตาจิตแด่ผู้เกษียณราชการ ในวันและเวลาดังกล่าว</p>\r\n</div>', 14, 7, '2020-11-17 02:55:44', '2020-11-17 02:55:45', 0, 0, 'enabled', 'กำหนดจัดงานเกษียณอายุราชการ-ประจำปี-2563'),
(1, 17, 'มหาวิทยาลัยราชภัฏลำปาง เปิดรับสมัครนักศึกษาใหม่ ประจำปีการศึกษา 2564 ', 'มหาวิทยาลัยราชภัฏลำปาง เปิดรับสมัครนักศึกษาใหม่ ประจำปีการศึกษา 2564 ระดับปริญญาตรี 4 ปี / ปริญญาตรี 4 ปี(เทียบโอน) / ปริญญาตรี 2 ปีต่อเนื่อง', '<p>มหาวิทยาลัยราชภัฏลำปาง เปิดรับสมัครนักศึกษาใหม่ ประจำปีการศึกษา 2564 ระดับปริญญาตรี 4 ปี / ปริญญาตรี 4 ปี(เทียบโอน) / ปริญญาตรี 2 ปีต่อเนื่อง<br /><span class=\"text_exposed_show\"><br />เปิดรับสมัครและชำระค่าสมัคร<br />รหว่างวันที่ 24 สิงหาคม - 6 พฤศจิกายน 2563<br /><span class=\"_5mfr\"><span class=\"_6qdm\">⬇️</span></span><span class=\"_5mfr\"><span class=\"_6qdm\">⬇️</span></span><span class=\"_5mfr\"><span class=\"_6qdm\">⬇️</span></span><span class=\"_5mfr\"><span class=\"_6qdm\">⬇️</span></span><span class=\"_5mfr\"><span class=\"_6qdm\">⬇️</span></span><span class=\"_5mfr\"><span class=\"_6qdm\">⬇️</span></span><br />ระบบสมัครออนไลน์<br /><a href=\"https://l.facebook.com/l.php?u=http%3A%2F%2Flprumis.lpru.ac.th%2Facademic%2FOnlineEnrol%2FMajorOpen.php%3Ffbclid%3DIwAR1Y__YpWQjhk_BCsPk_3NTjrVEpFw5PAEed-ffMhTXgfqY3_836RUieXsk&amp;h=AT0NqzDMW8C183ZaIK5Bzwe9F7cPPCXQDKtlpg1G4M4km02eoPDqZ80MBHnn4PCSNvay4jVb8nxpMuEdg5Y7oUuG7311G6JrYE0etFHZhos-GHjBkxUNki9BRvA4_6rfv97oudMC0T8AXpFqOF4xKGCPKnZX_oquYP8\" target=\"_blank\" rel=\"noopener nofollow\" data-ft=\"{\" data-lynx-mode=\"asynclazy\">http://lprumis.lpru.ac.th/academic/OnlineEnrol/MajorOpen.php</a><br />หลักสูตรที่เปิดรับสมัคร<br />ปริญญาตรี 4 ปี<br /><a href=\"https://l.facebook.com/l.php?u=http%3A%2F%2Flprumis.lpru.ac.th%2Facademic%2FOnlineEnrol%2FEnrollDoc%2Fenrol.pdf%3Ffbclid%3DIwAR3ufAq526y9UPFFM0G8WGGETJkB93bfDGa8nm0tqv9Rw2GkSGkcZVBt-ig&amp;h=AT2rAnUpfv4JA0MXxiArP1I9LkPDD_kGEe2aOAAi10jlublyJLDiOC-pGcd1B4FaS0L-g0E_PZz9otExgwl6NR3nUGb-PcQ9jsR0tB1_tO0Y5NeXLHPHWVRlSx8Bt60F3lAqzrUBGx1bXRd4s3qXAFpkcKiXwdHxtqk\" target=\"_blank\" rel=\"noopener nofollow\" data-ft=\"{\" data-lynx-mode=\"asynclazy\
(2, 18, 'มหาวิทยาลัยเป็นสถานที่สอบบรรจุครูผู้ช่วย และ ครม.ประกาศวันหยุด ที่ตรงกับการจัดกิจกรรม', 'แจ้งนักศึกษาชั้นปีที่ 1 รหัส 63 คะ เนื่องมาจากมหาวิทยาลัยเป็นสถานที่สอบบรรจุครูผู้ช่วย และ ครม.ประกาศวันหยุด ที่ตรงกับการจัดกิจกรรม รุ่นที่ 3 และ 4', '<p>แจ้งนักศึกษาชั้นปีที่ 1 รหัส 63 คะ<br />เนื่องมาจากมหาวิทยาลัยเป็น<wbr />สถานที่สอบบรรจุครูผู้ช่วย และ ครม.ประกาศวันหยุด ที่ตรงกับการจัดกิจกรรม รุ่นที่ 3 และ 4<br /><br />จึงขอเปลี่ยนแปลงเพื่อความเ<wbr />หมาะสมนะคะ โดย<br />รุ่น 1 และ 3 วันที่ 15-16 สิงหาคม 2563<span class=\"text_exposed_show\"><br />รุ่น 2 และ 4 วันที่ 22-23 สิงหาคม 2563<br /><br />**สีตามเดิม แต่เปลี่ยนวัน นะจ๊ะ**<br />ลงทะเบียนรายงานตัวที่อาคาร<wbr />บริการวิชาการ เวลา 08.00-19.00 น. นะจ๊ะ<br /><br />**หมายเหตุการเข้าร่วมกิจกรรม<br />สวมหน้ากากอนามัย<br />วันแรกของรุ่น สวมเสื้อยืดคอกลม กางเกงขายาว(ไม่ใช่กางเกงยี<wbr />น) สวมรองเท้าผ้าใบ<br />วันที่สองของรุ่น สวมชุดกิจกรรมของมหาวิทยาลั<wbr />ย สวมรองเท้าผ้าใบ<br /><br />ค่ายนี้ไปกลับนะคะ. ไม่นอนค้างจ้า!!</span></p>', 16, 7, '2020-11-17 03:05:50', '2020-11-17 03:05:50', 0, 0, 'enabled', 'มหาวิทยาลัยเป็นสถานที่สอบบรรจุครูผู้ช่วย-และ-ครมประกาศวันหยุด-ที่ตรงกับการจัดกิจกรรม'),
(2, 19, 'โครงการ อบรมเทคโนโลยีการออกแบบและเขียนแบบ ด้วย Archicad ThaiBIM', 'ศูนย์ถ่ายทอดเทคโนโลยีและวิศวกรรม คณะเทคโนโลยีอุตสาหกรรม จัดโครงการ อบรมเทคโนโลยีการออกแบบและเขียนแบบ ด้วย Archicad ThaiBIM', '<p>ศูนย์ถ่ายทอดเทคโนโลยีและวิ<wbr />ศวกรรม<br />คณะเทคโนโลยีอุตสาหกรรม จัดโครงการ<br />อบรมเทคโนโลยีการออกแบบและเ<wbr />ขียนแบบ<span class=\"text_exposed_show\"><br />ด้วย Archicad ThaiBIM<br />ระยะเวลาการอบรม : วันที่ 26 - 28 สิงหาคม 2563<br />สถานที่จัดอบรม : ศูนย์คอมพิวเตอร์ มร.ลป<br />จำนวน : 25 ท่าน<br /><br />รับสมัครตั้งแต่บัดนี้เป็นต<wbr />้นไป ถึง วันที่ 20 สิงหาคม 2563<br />ทาง&nbsp;<a href=\"https://l.facebook.com/l.php?u=http%3A%2F%2Fshorturl.at%2FbwJU2%3Ffbclid%3DIwAR0FHEhxeS1wTpNKqNDw-JhYtOpDWsJkyhUQdTwEy1pBGQ_FkugpVPXR7g0&amp;h=AT0KxjpR8oqt7W3kWPfTpuhOaNwfPTUchTmJHdP7CNn68_RuWcUkt2-4zNEl1Wrg-x4HJQ5-eDiJCbaRpbklzzcX09hR4wgj7iRK_K_QoQZNsj3zqJ-UulMwsHn5n2SplFFAflhjOw\" target=\"_blank\" rel=\"nofollow noopener\" data-lynx-mode=\"asynclazy\">http://shorturl.at/bwJU2</a><br />หรือเว็บไซต์&nbsp;<a href=\"https://l.facebook.com/l.php?u=http%3A%2F%2Fitetc.lpru.me%2Fthaibim%2Fregister%2F%3Ffbclid%3DIwAR0hw8p2yDoxYgBCf2T67pkLwx7OKMrKM_jGxHmpGh7G-PhBRmA4qxsv5Rc&amp;h=AT1kllOTwS1PKBXuhPFhMDMbLYSVG_wKPGUt7SCXk7LL9zRRF4PHZpxo-lw8gChYVtgoLWayiP4QIAqMM8xQJOOZbARXX35JKegWu50rN2-3SEbQgxTcCiLUbdURXrDcnfla57-gGg\" target=\"_blank\" rel=\"nofollow noopener\" data-lynx-mode=\"asynclazy\">http://itetc.lpru.me/<wbr />thaibim/register/</a><br /><br />ประกาศรายชื่อผู้เข้ารับการ<wbr />อบรม<br />ในวันที่ 21 สิงหาคม 2563<br />ทางเว็บไซต์&nbsp;<a href=\"http://itetc.lpru.me/thaibim/list/?fbclid=IwAR06Cm5_RIXpY019KT5M3oo_-a6tV5gUpQCBVFaZq6bA63ciBRJ06DBm8zE\" target=\"_blank\" rel=\"nofollow noopener\" data-lynx-mode=\"asynclazy\" data-lynx-uri=\"https://l.facebook.com/l.php?u=http%3A%2F%2Fitetc.lpru.me%2Fthaibim%2Flist%2F%3Ffbclid%3DIwAR06Cm5_RIXpY019KT5M3oo_-a6tV5gUpQCBVFaZq6bA63ciBRJ06DBm8zE&amp;h=AT25YdYyXHusMJvoOfzKJHBt98uBo09_EgEjumR5pC2pI3tFLT5t92gnVFv-2jWOFsxbZ5bbmgXKEfjOfxhyDX0t_LnnPV3KKYc-iwcemUO5MsyR55xeGhM-HP-AVCptcsPZ0VcRvQ\">http://itetc.lpru.me/<wbr />thaibim/list/</a><br /><br />ศูนย์ถ่ายทอดเทคโนโลยีและวิ<wbr />ศวกรรม<br />คณะเทคโนโลยีอุตสาหกรรม<br />หมายเลขติดต่อ : 085-6169574<br />Email : itechlpru@gmail.com</span></p>', 17, 7, '2020-11-17 03:09:48', '2020-11-17 03:09:49', 0, 0, 'enabled', 'โครงการ-อบรมเทคโนโลยีการออกแบบและเขียนแบบ-ด้วย-archicad-thaibim'),
(2, 20, 'กิจกรรมออกร้านขายของ กาดมั้ว ในงานประเพณียี่เป็ง ณ.หนองหัวหงอก ครั้งที่ 11', 'องค์การบริหารนักศึกษา เชิญชวนนักศึกษามหาวิทยาลัยราชภัฏลำปาง ร่วมจัดกิจกรรมออกร้านขายของ กาดมั้ว ในงานประเพณียี่เป็ง ณ.หนองหัวหงอก ครั้งที่ 11', '<p>องค์การบริหารนักศึกษา เชิญชวนนักศึกษามหาวิทยาลัย<wbr />ราชภัฏลำปาง ร่วมจัดกิจกรรมออกร้านขายขอ<wbr />ง กาดมั้ว ในงานประเพณียี่เป็ง ณ.หนองหัวหงอก ครั้งที่ 11<br />วันที่ 25 พฤศจิกายน 2563<br />ณ.ลานหน้าหอประชุมใหญ่ มหาวิทยาลัยราชภัฏลำปาง<br />--------------------------<wbr />--------------------------<wbr />----------------------<br />หมายเหตุ - ลงทะเบียนถึง 15/11/63<span class=\"text_exposed_show\"><br />- มีโต๊ะหน้าขาว 1ตัว ต่อ 1ร้าน<br />- เรียงร้านตามลำดับการลงทะเบ<wbr />ียน<br />- รับจำนวน 40 ร้าน<br />- งดถุงพลาสติก<br /><br />สามารถลงทะเบียนร้านค้าได้ท<wbr />ี่ :&nbsp;<a href=\"https://l.facebook.com/l.php?u=https%3A%2F%2Fforms.gle%2FQ9PRUSUygAFxjeGP7%3Ffbclid%3DIwAR0ZWCNks3DT_GF_czgq8oBb30-7mj9fh4_olGYjWSvx9Cvavxz-J399BjM&amp;h=AT2Cljcbuf3ysXwFbFglvt94stx6gaRAqmLV_wf8K-40uV-rl79TvDO_1IZO3zlGuaPtEY1-kHD9V6ujzBI1dex97AWuPRpyoz7vcYW-AUZkQAbyNWLSU1bH9EilMf2oc4gJYODxPw\" target=\"_blank\" rel=\"nofollow noopener\" data-lynx-mode=\"asynclazy\">https://forms.gle/<wbr />Q9PRUSUygAFxjeGP7</a><br />--------------------------<wbr />---<br /><span class=\"_5mfr\"><span class=\"_6qdm\">????</span></span><span class=\"_5mfr\"><span class=\"_6qdm\">????</span></span><span class=\"_5mfr\"><span class=\"_6qdm\">????</span></span>สิ้นสุดลงทะเบียน 15/11/63 นี้เท่านั้น<span class=\"_5mfr\"><span class=\"_6qdm\">❗</span></span><span class=\"_5mfr\"><span class=\"_6qdm\">❗</span></span><span class=\"_5mfr\"><span class=\"_6qdm\">❗</span></span><br />--------------------------<wbr />---<br />ติดต่อสอบถามข้อมูลเพิ่มเติ<wbr />มขายของ กาดมั้ว ได้ที่ 080-1333943 (นายกองค์การบริหารนักศึกษา<wbr />)</span></p>', 18, 7, '2020-11-17 03:12:04', '2020-11-17 03:12:04', 0, 0, 'enabled', 'กิจกรรมออกร้านขายของ-กาดมั้ว-ในงานประเพณียี่เป็ง-ณหนองหัวหงอก-ครั้งที่-11'),
(2, 21, 'ร่วมบริจาคโลหิต', 'มหาวิทยาลัยราชภัฏลำปาง ขอเชิญชวนคณาจารย์ บุคลากร เจ้าหน้าที่ และนักศึกษา ร่วมบริจาคโลหิต', '<p>มหาวิทยาลัยราชภัฏลำปาง ขอเชิญชวนคณาจารย์ บุคลากร เจ้าหน้าที่ และนักศึกษา ร่วมบริจาคโลหิต ในวันพุธที่ 11 พฤศจิกายน 2563 เวลา 09.00 น. - 12.00 น. ณ อาคารกองพัฒนานักศึกษา มหาวิทยาลัยราชภัฏลำปาง<br /><br /><a class=\"_58cn\" href=\"https://www.facebook.com/hashtag/%E0%B8%A3%E0%B8%B2%E0%B8%8A%E0%B8%A0%E0%B8%B1%E0%B8%8F%E0%B8%A5%E0%B8%B3%E0%B8%9B%E0%B8%B2%E0%B8%87%E0%B8%A3%E0%B9%88%E0%B8%A7%E0%B8%A1%E0%B9%83%E0%B8%88%E0%B8%81%E0%B9%89%E0%B8%B2%E0%B8%A7%E0%B8%AA%E0%B8%B9%E0%B9%88%E0%B8%9B%E0%B8%B5%E0%B8%97%E0%B8%B5%E0%B9%8850%E0%B8%AD%E0%B8%A2%E0%B9%88%E0%B8%B2%E0%B8%87%E0%B8%AA%E0%B8%94%E0%B9%83%E0%B8%AA%E0%B9%81%E0%B8%A5%E0%B8%B0%E0%B8%AA%E0%B8%A3%E0%B9%89%E0%B8%B2%E0%B8%87%E0%B8%AA%E0%B8%A3%E0%B8%A3%E0%B8%84%E0%B9%8C?epa=HASHTAG\" data-ft=\"{&quot;type&quot;:104,&quot;tn&quot;:&quot;*N&quot;}\">#ราชภัฏลำปางร่วมใจก้าวสู่ป<wbr />ีที่50อย่างสดใสและสร้างสรร<wbr />ค์</a></p>', 19, 7, '2020-11-17 03:13:59', '2020-11-17 03:13:59', 0, 0, 'enabled', 'ร่วมบริจาคโลหิต'),
(2, 22, 'งานประเพณียี่เป็ง ณ หนองหัวหงอก ครั้งที่ 11', 'งานประเพณียี่เป็ง ณ หนองหัวหงอก ครั้งที่ 11', '<p><a class=\"_58cn\" href=\"https://www.facebook.com/hashtag/%E0%B8%A3%E0%B8%B2%E0%B8%8A%E0%B8%A0%E0%B8%B1%E0%B8%8F%E0%B8%A5%E0%B8%B3%E0%B8%9B%E0%B8%B2%E0%B8%87%E0%B8%A3%E0%B9%88%E0%B8%A7%E0%B8%A1%E0%B9%83%E0%B8%88%E0%B8%81%E0%B9%89%E0%B8%B2%E0%B8%A7%E0%B8%AA%E0%B8%B9%E0%B9%88%E0%B8%9B%E0%B8%B5%E0%B8%97%E0%B8%B5%E0%B9%8850%E0%B8%AD%E0%B8%A2%E0%B9%88%E0%B8%B2%E0%B8%87%E0%B8%AA%E0%B8%94%E0%B9%83%E0%B8%AA%E0%B9%81%E0%B8%A5%E0%B8%B0%E0%B8%AA%E0%B8%A3%E0%B9%89%E0%B8%B2%E0%B8%87%E0%B8%AA%E0%B8%A3%E0%B8%A3%E0%B8%84%E0%B9%8C?epa=HASHTAG\" data-ft=\"{&quot;type&quot;:104,&quot;tn&quot;:&quot;*N&quot;}\">#ราชภัฏลำปางร่วมใจก้าวสู่ป<wbr />ีที่50อย่างสดใสและสร้างสรร<wbr />ค์</a></p>', 20, 7, '2020-11-17 03:16:12', '2020-11-17 03:16:12', 0, 0, 'enabled', 'งานประเพณียี่เป็ง-ณ-หนองหัวหงอก-ครั้งที่-11');
...
CREATE TABLE `news_type` (
  ...
  `type_primarylink` varchar(128) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `news_type` (`type_id`, `type_name`, `type_created`, `type_updated`, `type_primarylink`) VALUES
(1, 'ประชาสัมพันธ์', '2020-11-11 11:15:13', '2020-11-16 14:16:40', 'ประชาสัมพันธ์'),
(2, 'กิจกรรรม', '2020-11-11 11:15:27', '2020-11-16 14:16:35', 'กิจกรรรม'),
(3, 'ภาพกิจกรรมที่ผ่านมา', '2020-11-11 11:15:52', '2020-11-16 14:16:30', 'ภาพกิจกรรมที่ผ่านมา'),
(4, 'รางวัลที่ได้รับ', '2020-11-11 11:15:58', '2020-11-16 14:16:25', 'รางวัลที่ได้รับ'),
(5, 'ข่าวบุคลากร', '2020-11-11 11:16:07', '2020-11-16 14:16:19', 'ข่าวบุคลากร'),
(6, 'ข่าวรับสมัครงาน', '2020-11-11 11:16:14', '2020-11-16 14:16:13', 'ข่าวรับสมัครงาน'),
(7, 'ข่าวจัดซื้อจัดจ้าง', '2020-11-11 11:16:22', '2020-11-16 14:16:09', 'ข่าวจัดซื้อจัดจ้าง');

-- --------------------------------------------------------

--
-- Table structure for table `pages_fonts`
--

CREATE TABLE `pages_fonts` (
  `font_id` int(11) NOT NULL,
  `font_name` varchar(60) NOT NULL,
  `font_description` varchar(60) NOT NULL,
  `font_text_preview` varchar(160) NOT NULL,
  `font_specify` varchar(155) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `pages_fonts`
--

INSERT INTO `pages_fonts` (`font_id`, `font_name`, `font_description`, `font_text_preview`, `font_specify`) VALUES
(1, 'Kanit', '', 'เสียงที่บันทึกไว้ดังมาจากลำโพงเหนือประตู', 'font-family: \'Kanit\', sans-serif;'),
(2, 'Prompt', '', 'แล้วคืนแห่งดาวตกดวงแรกก็มาถึง', 'font-family: \'Prompt\', sans-serif;'),
(3, 'Itim', '', 'แทบจะไม่ทันได้รู้ตัว พวกเราก็ออกจากพื้นโลกแล้ว', 'font-family: \'Itim\', cursive;'),
(4, 'Trirong', '', 'โลกส่องแสงเป็นประกายเรืองรองอยู่ใกล้ๆ ใต้ยาน', 'font-family: \'Trirong\', serif;'),
(5, 'Chonburi', '', 'ไอหมอกห่อหุ้มเรือที่ออกจากท่าไป 3 ชั่วโมง', 'font-family: \'Chonburi\', cursive;'),
(6, 'Athiti', '', 'การเดินทางขากลับคงจะเหงา', 'font-family: \'Athiti\', sans-serif;'),
(7, 'Mitr', '', 'ขอบหยักของปีกแลดูเด่นชัดกลางแสงเรืองรองสีแดง', 'font-family: \'Mitr\', sans-serif;'),
(8, 'Taviraj', '', 'เครื่องมือและอุปกรณ์ทั้งหมดของพวกเขาพร้อมสำหรับการใช้งานแล้ว', 'font-family: \'Taviraj\', serif;'),
(9, 'Sriracha', '', 'ดวงจันทร์ซ่อนหน้าอยู่ในเงามืด', 'font-family: \'Sriracha\', cursive;'),
(10, 'Maitree', '', 'โลกส่องแสงเป็นประกายเรืองรองอยู่ใกล้ๆ ใต้ยาน', 'font-family: \'Maitree\', serif;'),
(11, 'Pridi', '', 'อยู่ที่ว่ามันจะเกิดขึ้นเมื่อไหร', 'font-family: \'Pridi\', serif;'),
(12, 'Pattaya', '', 'ท้องฟ้าไร้เมฆและเป็นสีน้ำเงินเข้มจัด', 'font-family: \'Pattaya\', sans-serif;');
...
CREATE TABLE `photos` (
  ...
  `photo_caption` varchar(160) NOT NULL,
  `photo_type` varchar(20) NOT NULL,
  `photo_size` varchar(30) NOT NULL,
  `photo_primalink` varchar(250) NOT NULL,
...
INSERT INTO `photos` (`photo_album_id`, `photo_id`, `photo_name`, `photo_caption`, `photo_type`, `photo_size`, `photo_primalink`, `photo_created`) VALUES
(2, 1, '3.jpg', '', 'jpg', '{\"width\":960,\"height\":720}', '', '2020-11-17 09:03:01'),
(2, 2, '2.jpg', '', 'jpg', '{\"width\":960,\"height\":720}', '', '2020-11-17 09:03:01'),
(2, 3, '1.jpg', '', 'jpg', '{\"width\":960,\"height\":720}', '', '2020-11-17 09:03:01');
...
INSERT INTO `photos_albums` (`album_obj_type`, `album_obj_id`, `album_id`, `album_name`, `album_description`, `album_created`, `album_updated`, `album_owner`, `album_company`) VALUES
('news', 'u-1', 1, 'อัลบัมรูปภาพ', '', NULL, NULL, 0, NULL),
('news', '6', 2, 'อัลบัมรูปภาพ', '', NULL, NULL, 0, NULL);
...
CREATE TABLE `staff` (
  ...
  `staff_created` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `staff_updated` timestamp NULL DEFAULT NULL,
  `staff_owner` int(1) NOT NULL,
  `staff_mode` varchar(5) NOT NULL,
  `staff_descrip` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `staff` (`staff_id`, `staff_prename`, `staff_firstname`, `staff_lastname`, `staff_refno`, `staff_level`, `staff_username`, `staff_password`, `staff_status`, `staff_created`, `staff_updated`, `staff_owner`, `staff_mode`, `staff_descrip`) VALUES
(1, 'Mr.', 'พชร', 'นันทอาภา', '9999', 99, 'admin', '$2y$10$44i0FEjxXEg6I6yFsaPAXecwqz6k7GtPF2FAIlJtzknrrP.5uT.la', 1, '2020-10-08 07:41:42', '2020-10-09 07:33:03', 1, 'dark', ''),
(7, 'Ms.', 'สุรินธรณ์', 'อินญาศรี', '', 99, 'admingun', '$2y$10$Dt7M2.9eobpModF6EMy18ucRS/zrqqOVcr7CTJJzzkPOESALi2xiO', 1, '2020-10-15 15:22:38', NULL, 0, 'blue', ''),
(8, 'Mr.', 'ทัชพล', 'สุธรรมมา', '1150', 2, 'tuchy', '$2y$10$TY2oV4tu/QNkQfEQ0OGJ0.D8ZRwChvRfErzMMRJx6Q1oz7h3yyJlS', 1, '2020-11-16 13:25:24', NULL, 0, '', ''),
(9, 'Mr.', 'ชยุต', 'ไชโย', '', 2, 'moo', '$2y$10$nq1Xvmdg/n45kXLicR4w9OjegNsYYv19j8cZaH4V2E3mTU0Yct1Qa', 1, '2021-01-07 08:54:40', NULL, 0, '', '');
...
INSERT INTO `staff_level` (`lev_id`, `lev_name`, `lev_decript`) VALUES
(1, 'เจ้าหน้าที่', ''),
(2, 'วิทยากร', ''),
(3, 'ผู้บริหาร', ''),
(8, 'นักศึกษา CB', ''),
...
('title', 'Technology and Engineering Transfer Center'),
('name', 'ศูนย์ถ่ายทอดเทคโนโลยีและวิศวกรรม'),
('font', '1'),
('description', '\"มุ่งสู่เทคโนโลยีและวิศวกรรม เพื่อพัฒนาสังคม\"');
...
ALTER TABLE `course`
  ...
  ADD KEY `course_staff_id` (`course_staff_id`);
...
ALTER TABLE `course_open`
  ...
  ADD KEY `open_staff_id` (`open_staff_id`);
...
ALTER TABLE `member`
  ...
  ADD KEY `mem_add3` (`mem_add_zipcode`),
  ADD KEY `mem_province_id` (`mem_add_province_id`,`mem_add_amphure_id`,`mem_add_district_id`);

--
-- Indexes for table `member_register`
--
ALTER TABLE `member_register`
  ADD KEY `mem_no` (`mem_id`),
  ADD KEY `reg_course_no` (`reg_course_id`),
  ADD KEY `reg_open_id` (`reg_open_id`);
...
ALTER TABLE `news`
  ...
  ADD KEY `new_update_id` (`new_update_id`),
  ADD KEY `new_image_id` (`new_image_id`);
...
--
-- Indexes for table `pages_fonts`
--
ALTER TABLE `pages_fonts`
...
ALTER TABLE `photos`
  ...
  ADD KEY `photo_album_id` (`photo_album_id`);

--
-- Indexes for table `photos_albums`
--
ALTER TABLE `photos_albums`
  ...
  ADD KEY `album_company` (`album_company`);
...
--
-- Indexes for table `staff_level`
--
ALTER TABLE `staff_level`
  ADD PRIMARY KEY (`lev_id`);
...
--
ALTER TABLE `course_open`
  MODIFY `open_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
...
--
ALTER TABLE `news`
  MODIFY `new_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
...
--
-- AUTO_INCREMENT for table `pages_fonts`
--
ALTER TABLE `pages_fonts`
...
--
ALTER TABLE `photos`
  MODIFY `photo_id` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `photos_albums`
--
ALTER TABLE `photos_albums`
