...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 28, 2020 at 03:55 PM
...
(6, '123402', 'ทดสอบ', 'test', '-', '-', '-', 40, '', '1', 0, 7, '2020-10-19 03:01:40', '2020-10-19 03:36:28'),
(7, '123403', 'ทดสอบ1', 'test1', '-', '-', '-', 30, '', '1', 0, 7, '2020-10-19 03:38:52', '2020-11-16 18:11:36');
...
(12, '7', '2563', '2564', '2020-10-19', '2020-10-19', '2020-10-19', '2', 600.00, 40, '2020-10-19', '2020-10-19', '', 0);
...
(1, 5, '126021626_2862480077368651_4362332690280673411_n.jpg', '', 'jpg', 1, 0, '2020-11-17 01:20:09');
...
CREATE TABLE `member` (
  ...
  `men_work_place` varchar(128) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
(3, 'Mr.', 'ธัชพล', 'สุธรรมมา', '1', '1997-10-07', '1529948578123', '4 ตรอก 2', 'ราชธรรมพิทักษ์', 0, 0, 0, '58000', '-', '2020-10-16', 'tuch', '$2y$10$TEMfDM.PfeKJi03R7/SntOOhIpQTKaHvjs/DprurrL3ihWhUtGs3a', '1', '2020-10-16 05:14:55', NULL, 'tuchchapon@gmail.com', '', ''),
...
(6, 'Ms.', 'สู้สู้', 'นะ', '2', '2020-10-01', '1529900906788', '599', '-', 0, 0, 0, '52300', '-', '2020-10-19', 'gun55', '$2y$10$TWuVhEAyn2I/veSmaWlgrOaanyz3eX2DCdk0Df5DlcYsCmCyLitAC', '0', '2020-10-19 04:56:04', NULL, 'surinthorn102@gmail.com', '', '');
...
(1, 7, 'ทดสอบข่าว', 'ทดสอบข่าว', '<p>ข่าวสาร</p>\r\n<p><img class=\"img\" src=\"/traininglevel/public/photos/c56b6a49aba9e7bb64eb3176252eb19d_91ee144cf8b308e0cfdbb60c13fad662.jpg\" alt=\"Art-Abstract-Windows-10-Wallpaper-For-Computer.jpg\" width=\"922\" height=\"576.3907203907204\" /></p>\r\n<p>BLOG</p>\r\n<p><img class=\"img\" src=\"/traininglevel/public/photos/c56b6a49aba9e7bb64eb3176252eb19d_051941de50f35aa6f63bd4266c49361c.jpg\" alt=\"150620.jpg\" width=\"922\" height=\"518.625\" /></p>\r\n<p>&nbsp;</p>', 5, 1, '2020-11-16 18:20:09', '2020-11-16 18:20:09', 0, 0, 'enabled', 'ทดสอบข่าว');
...
(1, 'ประชาสัมพันธ์', '2020-11-11 11:15:13', '2020-11-16 14:17:35', 'ประชาสัมพันธ์'),
(2, 'กิจกรรรม', '2020-11-11 11:15:27', '2020-11-16 14:17:31', 'กิจกรรรม'),
(3, 'ภาพกิจกรรมที่ผ่านมา', '2020-11-11 11:15:52', '2020-11-16 14:17:33', 'ภาพกิจกรรมที่ผ่านมา'),
(4, 'รางวัลที่ได้รับ', '2020-11-11 11:15:58', '2020-11-16 14:17:29', 'รางวัลที่ได้รับ'),
(5, 'ข่าวบุคลากร', '2020-11-11 11:16:07', '2020-11-16 14:17:28', 'ข่าวบุคลากร'),
(6, 'ข่าวรับสมัครงาน', '2020-11-11 11:16:14', '2020-11-16 14:17:26', 'ข่าวรับสมัครงาน'),
(7, 'ข่าวจัดซื้อจัดจ้าง', '2020-11-11 11:16:22', '2020-11-16 14:17:25', 'ข่าวจัดซื้อจัดจ้าง');
...
(2, 4, '150620.jpg', '', 'jpg', '{\"width\":1920,\"height\":1080}', '', '2020-11-17 01:19:46'),
(2, 5, 'Art-Abstract-Windows-10-Wallpaper-For-Computer.jpg', '', 'jpg', '{\"width\":1638,\"height\":1024}', '', '2020-11-17 01:19:46'),
(2, 6, 'Capture.PNG', '', 'jpg', '{\"width\":325,\"height\":267}', '', '2020-11-17 01:19:47');
...
('news', '7', 2, 'อัลบัมรูปภาพ', '', NULL, NULL, 0, NULL);
...
CREATE TABLE `webinfo` (
  ...
  `info_primarylink` varchar(300) NOT NULL,
  `info_detail` text NOT NULL,
  `info_created` datetime NOT NULL DEFAULT current_timestamp(),
  `info_updated` datetime DEFAULT NULL ON UPDATE current_timestamp(),
  `info_status` int(1) NOT NULL,
  `info_seq` int(2) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `webinfo` (`info_id`, `info_name`, `info_primarylink`, `info_detail`, `info_created`, `info_updated`, `info_status`, `info_seq`) VALUES
(1, 'ประวัติ', 'ประวัติ', '<p>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; คณะเทคโนโลยีอุตสาหกรรม มีพัฒนาการมาจากหมวดวิชาหัตถศึกษา เริ่มเปิดการเรียนการสอนในปี พ.ศ.2515 และได้รับการอนุมัติ ให้มีโครงการจัดตั้งคณะเทคโนโลยีอุตสาหกรรม ในปี 2543 โดย ให้มีฐานะและการบริหารงานในรูปแบบของคณะวิชาภายใน สถาบันราชภัฏลําปาง และได้ยกระดับเป็นคณะเทคโนโลยีอุตสาหกรรม ในปี พ.ศ.2548</p>\r\n<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ด้านการบริการวิชาการ คณะเทคโนโลยีอุตสาหกรรมได้มีการจัดตั้งศูนย์ถ่ายทอดเทคโนโลยีอุตสาหกรรม โดยผ่านลงนามบันทึกข้อตกลง ความร่วมมือกับสภาอุตสาหกรรมจังหวัดลําปาง ในการดําเนินการดําเนินการโครงการคูปองนวัตกรรม และการลงนามบันทึกข้อตกลงความร่วมมือด้านวิชาการและการวิจัยระหว่างสถาบันอุดมภาคเหนือด้านพลังงานสิ่งแวดล้อมและการพัฒนาเศรษฐกิจชุมชน และสํานักงานกองทุน สนับสนุนการวิจัย และในปัจจุบันได้ลงนามบันทึกข้อตกลงด้านการเรียนการสอนและการบริการวิชาการ ร่วมกับวิทยาลัยเทคโนโลยีและการจั ตการ กฟผ. แม่เมาะ และการลงนามบันทึกข้อตกลงความร่วมมือการจัดการศึกษาและบริการทางวิชาการของเครือข่ายพลังงานมหาวิทยาลัย ราชภัฏภาคเหนือ</p>', '2020-11-28 21:34:16', '2020-11-28 21:34:33', 1, 0),
(2, 'ปรัชญา วิสัยทัศน์ พันธกิจ', 'ปรัชญา-วิสัยทัศน์-พันธกิจ', '', '2020-11-28 21:51:51', '2020-11-28 21:52:16', 1, 0),
(3, 'ตราสัญลักษณ์', 'ตราสัญลักษณ์', '', '2020-11-28 21:51:55', '2020-11-28 21:52:14', 1, 0),
(4, 'บุคลากร', 'บุคลากร', '', '2020-11-28 21:52:00', '2020-11-28 21:52:11', 1, 0);
...
--
ALTER TABLE `course_open`
  MODIFY `open_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `photos`
  MODIFY `photo_id` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
