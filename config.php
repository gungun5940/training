...
define('URL', 'http://localhost/traininglevel/');

define('DB_TYPE', 'mysql');
define('DB_HOST', 'localhost');
define('DB_NAME', 'traininglevel');
define('DB_USER', 'root');
define('DB_PASS', '');
...
define('WWW_UPLOADS_PDF', ROOT . DS . "public". DS. 'uploads' . DS . 'pdf' . DS);
define('WWW_UPLOADS_WORD', ROOT . DS . "public". DS. 'uploads' . DS . 'word' . DS);
define('WWW_UPLOADS_SLIP', ROOT . DS . "public". DS. 'uploads' . DS . 'slip' . DS);
...
define('FILE_PDF', URL . "public/uploads/pdf/");
define('FILE_WORD', URL . "public/uploads/word/");
define('FILE_SLIP', URL . "public/uploads/slip/");

define('WWW_PHOTOS', ROOT . DS . "public". DS. 'photos' . DS);
define('PHOTOS', URL . "public/photos/");

define('LANG', 'th');
define('COOKIE_KEY_TYPE', 'u_type');
