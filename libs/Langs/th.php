...
class th extends Langs {
	...
	public function basics($text=null) {
		...
		$data['username'] = 'ชื่อผู้ใช้';
		$data['language'] = 'ภาษา';
		$data['themes'] = 'ธีม';

		$data['first name'] = 'ชื่อ';
		$data['last name'] = 'นามสกุล';
		$data['nickname'] = 'ชื่อเล่น';

		$data['preferences'] = 'การตั้งค่า';
		$data['accounts'] = 'บัญชีผู้ใช้';
		$data['student'] = 'นักศึกษา';
		$data['corporation'] = 'สถานประกอบการ';

		$data['my'] = 'โปรไฟล์';
		$data['system'] ='ระบบเว็บไซต์'; 

		$data['users'] = 'ผู้ใช้งาน';

		$data['faculty'] = 'คณะ';
		$data['majors'] = 'สาขาวิชา';
