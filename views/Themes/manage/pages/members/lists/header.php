	...
	<div ref="actions" class="listpage2-actions">
		<div class="clearfix mbs mtm">
			...
			<ul class="lfloat" ref="actions">
				<li class="mt">
					<h2><i class="icon-users mrs"></i><span>ข้อมูลสมาชิกหรือผู้เข้าร่วมอบรม</span></h2>
				</li>
				...
				<li class="mt">
					<a class="btn btn-blue" href="<?=$this->pageURL?>members/add">
						<i class="icon-plus mrs"></i><span><?=$this->lang->translate('Add New')?></span>
					</a>
				</li>
		...
		<div class="clearfix mbl mtm">
			<ul class="lfloat" ref="control">
				<li>
					<label for="gender" class="label">เพศ</label>
					<select ref="selector" name="gender" class="inputtext">
						<option value="">-</option>
						<?php
