<div class="profile-left" role="left" data-width="260">
	<div class="profile-left-header" role="leftHeader" style="background-color:#f39c12;">
		<div class="profile-left-title">
			<h2><i class="icon-graduation-cap"></i> ตั้งค่า</h2>
	...
	<div class="profile-left-details form-insert-people" style="padding-top: 10px;">
		<div class="tac">
			<a href="<?=URL?>webinfo/add" data-plugins="dialog" class="mrs mts btn btn-blue btn-small">เพิ่มหัวข้อใหม่</a>
		</div>
